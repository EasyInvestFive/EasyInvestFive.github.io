...
!function(e, t) {
    ...
    function u(e, t, n, i) {
        if (oe.acceptData(e)) {
            var r, o, a = oe.expando, s = e.nodeType, l = s ? oe.cache : e, c = s ? e[a] : e[a] && a;
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof t)
                return c || (c = s ? e[a] = X.pop() || oe.guid++ : a),
                l[c] || (l[c] = s ? {} : {
                    toJSON: oe.noop
                }),
    ...
    function p(e, t, n) {
        if (oe.acceptData(e)) {
            ...
            if (a[s]) {
                ...
                (n || (delete a[s].data,
                    c(a[s]))) && (o ? oe.cleanData([e], !0) : ie.deleteExpando || a != a.window ? delete a[s] : a[s] = null)
            }
        }
    }
    function d() {
    ...
    function y(e, t) {
        var n, i, r = 0, o = typeof e.getElementsByTagName !== Pe ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll !== Pe ? e.querySelectorAll(t || "*") : void 0;
        if (!o)
            for (o = [],
                     n = e.childNodes || e; null != (i = n[r]); r++)
                !t || oe.nodeName(i, t) ? o.push(i) : oe.merge(o, y(i, t));
    ...
    function T(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            ie.html5Clone && e.innerHTML && !oe.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Ee.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
    ...
    function k(e) {
        var t = me
            , n = et[e];
        return n || (n = P(e, t),
        "none" !== n && n || (Je = (Je || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
    ...
    function j(e, t) {
        for (var n, i, r, o = [], a = 0, s = e.length; a < s; a++)
            i = e[a],
            i.style && (o[a] = oe._data(i, "olddisplay"),
                n = i.style.display,
                t ? (o[a] || "none" !== n || (i.style.display = ""),
                "" === i.style.display && $e(i) && (o[a] = oe._data(i, "olddisplay", k(i.nodeName)))) : o[a] || (r = $e(i),
    ...
    function Y(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2)
            "margin" === n && (a += oe.css(e, n + je[o], !0, r)),
                i ? ("content" === n && (a -= oe.css(e, "padding" + je[o], !0, r)),
                "margin" !== n && (a -= oe.css(e, "border" + je[o] + "Width", !0, r))) : (a += oe.css(e, "padding" + je[o], !0, r),
                "padding" !== n && (a += oe.css(e, "border" + je[o] + "Width", !0, r)));
        return a
    }
    function E(e, t, n) {
        var i = !0
    ...
    function Q(e, t, n) {
        var i, r, o, a, s, l, c, u, p = this, d = {}, f = e.style, h = e.nodeType && $e(e), m = oe._data(e, "fxshow");
        ...
        1 === e.nodeType && ("height"in t || "width"in t) && (n.overflow = [f.overflow, f.overflowX, f.overflowY],
            ...
            u = k(e.nodeName),
        "none" === c && (c = u),
        "inline" === c && "none" === oe.css(e, "float") && (ie.inlineBlockNeedsLayout && "inline" !== u ? f.zoom = 1 : f.display = "inline-block")),
        n.overflow && (f.overflow = "hidden",
        ie.shrinkWrapBlocks() || p.always(function() {
    ...
    function L(e, t, n) {
        var i, r, o = 0, a = bt.length, s = oe.Deferred().always(function() {
            ...
            if (r)
                return !1;
            for (var t = ht || M(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, o = 1 - i, a = 0, l = c.tweens.length; a < l; a++)
                c.tweens[a].run(o);
                ...
                if (null != (r = arguments[s]))
                    for (i in r)
                        ...
                        a !== n && (c && n && (oe.isPlainObject(n) || (t = oe.isArray(n))) ? (t ? (t = !1,
                            ...
                            a[i] = oe.extend(c, o, n)) : void 0 !== n && (a[i] = n));
            return a
        }
        ,
        oe.extend({
    ...
    var ue = function(e) {
        function t(e, t, n, i) {
            ...
            if ((t ? t.ownerDocument || t : N) !== A && E(t),
                t = t || A,
                n = n || [],
            !e || "string" != typeof e)
                return n;
            ...
            if (D && !i) {
                ...
                if (T.qsa && (!I || !I.test(e))) {
                    ...
                    1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (c = d(e),
                                 (p = t.getAttribute("id")) ? h = p.replace(xe, "\\$&") : t.setAttribute("id", h),
                                 h = "[id='" + h + "'] ",
                                 l = c.length; l--; )
                            c[l] = h + f(c[l]);
                        m = be.test(e) && u(t.parentNode) || t,
                            y = c.join(",")
                    }
                    if (y)
                        try {
                            return J.apply(n, m.querySelectorAll(y)),
                                n
                        } catch (v) {} finally {
        ...
        function n() {
            function e(n, i) {
                return t.push(n + " ") > P.cacheLength && delete e[t.shift()],
                    e[n + " "] = i
            }
            var t = [];
            return e
        ...
        function v(e, t, n, r, o, a) {
            ...
            o && !o[O] && (o = v(o, a)),
                i(function(i, a, s, l) {
                    var c, u, p, d = [], f = [], h = a.length, m = i || x(t || "*", s.nodeType ? [s] : s, []), v = !e || !i && t ? m : y(m, d, e, s, l), g = n ? o || (i ? e : h || r) ? [] : a : v;
                    if (n && n(v, g, s, l),
                        r)
                        for (c = y(g, f),
                                 r(c, [], s, l),
                    ...
                    if (i) {
                        if (o || e) {
                            ...
                            for (u = g.length; u--; )
                                (p = g[u]) && (c = o ? te.call(i, p) : d[u]) > -1 && (i[c] = !(a[c] = p))
                        }
                    } else
                        g = y(g === a ? g.splice(h, g.length) : g),
                            o ? o(null, a, g, l) : J.apply(a, g)
                })
        }
        function g(e) {
            for (var t, n, i, r = e.length, o = P.relative[e[0].type], a = o || P.relative[" "], s = o ? 1 : 0, l = h(function(e) {
                ...
                if (n = P.relative[e[s].type])
                    u = [h(m(u), n)];
                else {
                    if (n = P.filter[e[s].type].apply(null, e[s].matches),
                        n[O]) {
        ...
        function b(e, n) {
            var r = n.length > 0
                ...
                var u, p, d, f = 0, h = "0", m = i && [], v = [], g = j, b = i || o && P.find.TAG("*", c), x = B += null == g ? 1 : Math.random() || .1, _ = b.length;
        ...
        function _(e, t, n, i) {
            ...
            if (!i && 1 === c.length) {
                ...
                o.length > 2 && "ID" === (a = o[0]).type && T.getById && 9 === t.nodeType && D && P.relative[o[1].type]) {
                    if (t = (P.find.ID(a.matches[0].replace(_e, we), t) || [])[0],
                        !t)
                        return n;
            ...
            return C(e, c)(i, t, !D, n, be.test(e) && u(t.parentNode) || t),
                n
        }
        var w, T, P, k, S, C, j, $, Y, E, A, M, D, I, Q, F, L, O = "sizzle" + -new Date, N = e.document, B = 0, z = 0, R = n(), H = n(), q = n(), W = function(e, t) {
            return e === t && (Y = !0),
                0
        }, V = "undefined", X = 1 << 31, U = {}.hasOwnProperty, G = [], Z = G.pop, K = G.push, J = G.push, ee = G.slice, te = G.indexOf || function(e) {
            for (var t = 0, n = this.length; t < n; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
            , ne = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ie = "[\\x20\\t\\r\\n\\f]", re = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", oe = re.replace("w", "w#"), ae = "\\[" + ie + "*(" + re + ")" + ie + "*(?:([*^$|!~]?=)" + ie + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + oe + ")|)|)" + ie + "*\\]", se = ":(" + re + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + ae.replace(3, 8) + ")*)|.*)\\)|)", le = new RegExp("^" + ie + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ie + "+$","g"), ce = new RegExp("^" + ie + "*," + ie + "*"), ue = new RegExp("^" + ie + "*([>+~]|" + ie + ")" + ie + "*"), pe = new RegExp("=" + ie + "*([^\\]'\"]*?)" + ie + "*\\]","g"), de = new RegExp(se), fe = new RegExp("^" + oe + "$"), he = {
            ID: new RegExp("^#(" + re + ")"),
            CLASS: new RegExp("^\\.(" + re + ")"),
        ...
        }, me = /^(?:input|select|textarea|button)$/i, ye = /^h\d$/i, ve = /^[^{]+\{\s*\[native \w/, ge = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, be = /[+~]/, xe = /'|\\/g, _e = new RegExp("\\\\([\\da-f]{1,6}" + ie + "?|(" + ie + ")|.)","ig"), we = function(e, t, n) {
            var i = "0x" + t - 65536;
            return i !== i || n ? t : i < 0 ? String.fromCharCode(i + 65536) : String.fromCharCode(i >> 10 | 55296, 1023 & i | 56320)
        };
        try {
            J.apply(G = ee.call(N.childNodes), N.childNodes),
        ...
        T = t.support = {},
            ...
            E = t.setDocument = function(e) {
                var t, n = e ? e.ownerDocument || e : N, i = n.defaultView;
                ...
                i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
                    ...
                    P.find.CLASS = T.getElementsByClassName && function(e, t) {
                        if (typeof t.getElementsByClassName !== V && D)
                            return t.getElementsByClassName(e)
                    }
                    ,
                    Q = [],
                    I = [],
                (T.qsa = ve.test(n.querySelectorAll)) && (r(function(e) {
                ...
                (T.matchesSelector = ve.test(F = M.webkitMatchesSelector || M.mozMatchesSelector || M.oMatchesSelector || M.msMatchesSelector)) && r(function(e) {
                    ...
                    L = t || ve.test(M.contains) ? function(e, t) {
                    ...
                    W = t ? function(e, t) {
                            ...
                            return i ? i : (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1,
                                1 & i || !T.sortDetached && t.compareDocumentPosition(e) === i ? e === n || e.ownerDocument === N && L(N, e) ? -1 : t === n || t.ownerDocument === N && L(N, t) ? 1 : $ ? te.call($, e) - te.call($, t) : 0 : 4 & i ? -1 : 1)
                        }
                        : function(e, t) {
                            if (e === t)
                                return Y = !0,
                            ...
                            if (!o || !s)
                                return e === n ? -1 : t === n ? 1 : o ? -1 : s ? 1 : $ ? te.call($, e) - te.call($, t) : 0;
                            if (o === s)
                                return a(e, t);
            ...
            t.matchesSelector = function(e, n) {
                if ((e.ownerDocument || e) !== A && E(e),
                    n = n.replace(pe, "='$1']"),
                T.matchesSelector && D && (!Q || !Q.test(n)) && (!I || !I.test(n)))
                    try {
                        var i = F.call(e, n);
                ...
                filter: {
                    ...
                    ATTR: function(e, n, i) {
                        return function(r) {
                            var o = t.attr(r, e);
                            return null == o ? "!=" === n : !n || (o += "",
                                "=" === n ? o === i : "!=" === n ? o !== i : "^=" === n ? i && 0 === o.indexOf(i) : "*=" === n ? i && o.indexOf(i) > -1 : "$=" === n ? i && o.slice(-i.length) === i : "~=" === n ? (" " + o + " ").indexOf(i) > -1 : "|=" === n && (o === i || o.slice(0, i.length + 1) === i + "-"))
                        }
                    },
                    CHILD: function(e, t, n, i, r) {
                        ...
                        return 1 === i && 0 === r ? function(e) {
                            ...
                            : function(t, n, l) {
                                var c, u, p, d, f, h, m = o !== a ? "nextSibling" : "previousSibling", y = t.parentNode, v = s && t.nodeName.toLowerCase(), g = !l && !s;
                                if (y) {
                                    if (o) {
                                        for (; m; ) {
                                            for (p = t; p = p[m]; )
                                    ...
                                    a && g) {
                                        for (u = y[O] || (y[O] = {}),
                                                 ...
                                                 f = c[0] === B && c[1],
                                                 d = c[0] === B && c[2],
                                                 p = f && y.childNodes[f]; p = ++f && p && p[m] || (d = f = 0) || h.pop(); )
                                            if (1 === p.nodeType && ++d && p === t) {
                                                u[e] = [B, f, d];
                                                break
                                            }
                                    } else if (g && (c = (t[O] || (t[O] = {}))[e]) && c[0] === B)
                                        d = c[1];
                                    else
                                        for (; (p = ++f && p && p[m] || (d = f = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++d || (g && ((p[O] || (p[O] = {}))[e] = [B, d]),
                                        p !== t)); )
                                            ;
                                    return d -= r,
                                    d === i || d % i === 0 && d / i >= 0
                    ...
                    PSEUDO: function(e, n) {
                        ...
                        return o[O] ? o(n) : o.length > 1 ? (r = [e, e, "", n],
                                P.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, t) {
        ...
        for (w in {
            ...
            P.pseudos[w] = l(w);
        return p.prototype = P.filters = P.pseudos,
            P.setFilters = new p,
            ...
            ,
            T.sortStable = O.split("").sort(W).join("") === O,
    ...
    oe.Callbacks = function(e) {
        ...
        var t, n, i, r, a, s, l = [], c = !e.once && [], u = function(o) {
            ...
            t = !1,
            l && (c ? c.length && u(c.shift()) : n ? l = [] : p.disable())
        }, p = {
            add: function() {
                if (l) {
                    var i = l.length;
        ...
        oe.extend({
            ...
            when: function(e) {
                var t, n, i, r = 0, o = U.call(arguments), a = o.length, s = 1 !== a || e && oe.isFunction(e.promise) ? a : 0, l = 1 === s ? e : oe.Deferred(), c = function(e, n, i) {
                    return function(r) {
                        n[e] = this,
                ...
                if (a > 1)
                    for (t = new Array(a),
                             n = new Array(a),
                             i = new Array(a); r < a; r++)
                        o[r] && oe.isFunction(o[r].promise) ? o[r].promise().done(c(r, i, o)).fail(l.reject).progress(c(r, n, t)) : --s;
        ...
        oe.extend({
            ...
            ready: function(e) {
                if (e === !0 ? !--oe.readyWait : !oe.isReady) {
                    ...
                    oe.isReady = !0,
                    e !== !0 && --oe.readyWait > 0 || (we.resolveWith(me, [oe]),
    ...
    ie.ownLast = "0" !== Te,
        ...
        oe(function() {
            ...
            typeof t.style.zoom !== Pe && (t.style.cssText = "border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1",
    ...
    oe.event = {
            ...
            if (y) {
                for (n.handler && (l = n,
                    ...
                    r = l.selector),
                     ...
                     (u = y.handle) || (u = y.handle = function(e) {
            ...
            if (y && (u = y.events)) {
                for (t = (t || "").match(xe) || [""],
                    ...
                    if (s = Qe.exec(t[c]) || [],
                        ...
                        l && !d.length && (p.teardown && p.teardown.call(e, h, y.handle) !== !1 || oe.removeEvent(e, f, y.handle),
                            delete u[f])
                    } else
                        for (f in u)
                            oe.event.remove(e, f + t[c], n, i, !0);
                oe.isEmptyObject(u) && (delete y.handle,
                    oe._removeData(e, "events"))
            }
        },
        trigger: function(t, n, i, r) {
            var o, a, s, l, c, u, p, d = [i || me], f = te.call(t, "type") ? t.type : t, h = te.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = u = i = i || me,
            3 !== i.nodeType && 8 !== i.nodeType && !Ie.test(f + oe.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."),
                f = h.shift(),
                h.sort()),
                a = f.indexOf(":") < 0 && "on" + f,
            ...
            r || !c.trigger || c.trigger.apply(i, n) !== !1)) {
                ...
                if (t.type = f,
                !r && !t.isDefaultPrevented() && (!c._default || c._default.apply(d.pop(), n) === !1) && oe.acceptData(i) && a && i[f] && !oe.isWindow(i)) {
                    u = i[a],
                    u && (i[a] = null),
        ...
        dispatch: function(e) {
            e = oe.event.fix(e);
            var t, n, i, r, o, a = [], s = U.call(arguments), l = (oe._data(this, "events") || {})[e.type] || [], c = oe.event.special[e.type] || {};
            if (s[0] = e,
                ...
                for (a = oe.event.handlers.call(this, e, l),
                    ...
                    for (e.currentTarget = r.elem,
                        ...
                        e.namespace_re && !e.namespace_re.test(i.namespace) || (e.handleObj = i,
                            e.data = i.data,
                            n = ((oe.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, s),
        ...
        fix: function(e) {
            ...
            for (a || (this.fixHooks[r] = a = De.test(r) ? this.mouseHooks : Me.test(r) ? this.keyHooks : {}),
        ...
        oe.removeEvent = me.removeEventListener ? function(e, t, n) {
            ...
            : function(e, t, n) {
                var i = "on" + t;
                e.detachEvent && (typeof e[i] === Pe && (e[i] = null),
                    e.detachEvent(i, n))
            }
        ,
        oe.Event = function(e, t) {
            return this instanceof oe.Event ? (e && e.type ? (this.originalEvent = e,
                this.type = e.type,
                this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && (e.returnValue === !1 || e.getPreventDefault && e.getPreventDefault()) ? d : f) : this.type = e,
            t && oe.extend(this, t),
    ...
    Ge.optgroup = Ge.option,
        ...
        oe.extend({
            clone: function(e, t, n) {
                ...
                if (ie.html5Clone || oe.isXMLDoc(e) || !Oe.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Ke.innerHTML = e.outerHTML,
            ...
            buildFragment: function(e, t, n, i) {
                    ...
                    o || 0 === o)
                        if ("object" === oe.type(o))
                            ...
                            for (s = s || d.appendChild(t.createElement("div")),
                                     ...
                                     u = Ge[l] || Ge._default,
                                     s.innerHTML = u[1] + o.replace(Be, "<$1></$2>") + u[2],
                                     r = u[0]; r--; )
                                s = s.lastChild;
                            if (!ie.leadingWhitespace && Ne.test(o) && f.push(t.createTextNode(Ne.exec(o)[0])),
                                !ie.tbody)
                                for (o = "table" !== l || Re.test(o) ? "<table>" !== u[1] || Re.test(o) ? 0 : s : s.firstChild,
                ...
                for (s && d.removeChild(s),
                     ie.appendChecked || oe.grep(y(f, "input"), v),
                         h = 0; o = f[h++]; )
                    if ((!i || oe.inArray(o, i) === -1) && (a = oe.contains(o.ownerDocument, o),
            ...
            cleanData: function(e, t) {
                for (var n, i, r, o, a = 0, s = oe.expando, l = oe.cache, c = ie.deleteExpando, u = oe.event.special; null != (n = e[a]); a++)
                    if ((t || oe.acceptData(n)) && (r = n[s],
                        o = r && l[r])) {
                        if (o.events)
                            for (i in o.events)
                                u[i] ? oe.event.remove(n, i) : oe.removeEvent(n, i, o.handle);
                        l[r] && (delete l[r],
                            c ? delete n[s] : typeof n.removeAttribute !== Pe ? n.removeAttribute(s) : n[s] = null,
                            X.push(r))
                    }
            }
        }),
        oe.fn.extend({
            ...
            remove: function(e, t) {
                for (var n, i = e ? oe.filter(e, this) : this, r = 0; null != (n = i[r]); r++)
                    ...
                    n.parentNode && (t && oe.contains(n.ownerDocument, n) && _(y(n, "script")),
            ...
            domManip: function(e, t) {
                e = G.apply([], e);
                var n, i, r, o, a, s, l = 0, c = this.length, u = this, p = c - 1, d = e[0], f = oe.isFunction(d);
                if (f || c > 1 && "string" == typeof d && !ie.checkClone && We.test(d))
                ...
                1 === s.childNodes.length && (s = n),
                    n)) {
                    for (o = oe.map(y(s, "script"), b),
                             r = o.length; l < c; l++)
                        i = s,
                        l !== p && (i = oe.clone(i, !0, !0),
                        r && oe.merge(o, y(i, "script"))),
                            t.call(this[l], i, l);
                    if (r)
                        for (a = o[o.length - 1].ownerDocument,
                                 ...
                                 l = 0; l < r; l++)
                            i = o[l],
                            Ve.test(i.type || "") && !oe._data(i, "globalEval") && oe.contains(a, i) && (i.src ? oe._evalUrl && oe._evalUrl(i.src) : oe.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Ue, "")));
                    s = n = null
                }
                return this
            }
        ...
        oe.each({
            ...
            oe.fn[e] = function(e) {
                for (var n, i = 0, r = [], o = oe(e), a = o.length - 1; i <= a; i++)
            ...
            ie.shrinkWrapBlocks = function() {
                ...
                if (null == t) {
                    ...
                    o = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px",
                        ...
                        t = !1,
                    typeof r.style.zoom !== Pe && (r.style.cssText = i + ";width:1px;padding:1px;zoom:1",
                        r.innerHTML = "<div></div>",
    ...
    var tt, nt, it = /^margin/, rt = new RegExp("^(" + Ce + ")(?!px)[a-z%]+$","i"), ot = /^(top|right|bottom|left)$/;
    e.getComputedStyle ? (tt = function(e) {
        ...
        function() {
            ...
            var n, i, r, o, a, s, l = me.createElement("div"), c = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px", u = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0";
    ...
    oe.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (t = oe.cssProps[s] || (oe.cssProps[s] = C(l, s)),
                    a = oe.cssHooks[t] || oe.cssHooks[s],
                void 0 === n)
                    return a && "get"in a && void 0 !== (r = a.get(e, !1, i)) ? r : l[t];
                if (o = typeof n,
                "string" === o && (r = ut.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(oe.css(e, t)),
                    o = "number"),
        ...
        css: function(e, t, n, i) {
            ...
            return t = oe.cssProps[s] || (oe.cssProps[s] = C(e.style, s)),
                a = oe.cssHooks[t] || oe.cssHooks[s],
        ...
        oe.each(["height", "width"], function(e, t) {
            oe.cssHooks[t] = {
                get: function(e, n, i) {
                    if (n)
                        return 0 === e.offsetWidth && lt.test(oe.css(e, "display")) ? oe.swap(e, pt, function() {
                            return E(e, t, i)
                        }) : E(e, t, i)
                },
                set: function(e, n, i) {
    ...
    ie.opacity || (oe.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            "" === t || i && !i.filter) || (n.filter = at.test(o) ? o.replace(at, r) : o + " " + r)
        }
    }),
        ...
        oe.fx.step = {};
    var ht, mt, yt = /^(?:toggle|show|hide)$/, vt = new RegExp("^(?:([+-])=|)(" + Ce + ")([a-z%]*)$","i"), gt = /queueHooks$/, bt = [Q], xt = {
        "*": [function(e, t) {
    ...
    oe.Animation = oe.extend(L, {
        ...
        oe.fn.extend({
            ...
            finish: function(e) {
                return e !== !1 && (e = e || "fx"),
                    this.each(function() {
                        var t, n = oe._data(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = oe.timers, a = i ? i.length : 0;
                        for (n.finish = !0,
                                 oe.queue(this, e, []),
    ...
    var wt, Tt, Pt = oe.expr.attrHandle, kt = /^(?:checked|selected)$/i, St = ie.getSetAttribute, Ct = ie.input;
    oe.fn.extend({
        attr: function(e, t) {
        ...
        oe.extend({
            attr: function(e, t, n) {
                ...
                if (e && 3 !== o && 8 !== o && 2 !== o)
                    return typeof e.getAttribute === Pe ? oe.prop(e, t, n) : (1 === o && oe.isXMLDoc(e) || (t = t.toLowerCase(),
                        i = oe.attrHooks[t] || (oe.expr.match.bool.test(t) ? Tt : wt)),
            ...
            removeAttr: function(e, t) {
                ...
                if (o && 1 === e.nodeType)
                    for (; n = o[r++]; )
                        i = oe.propFix[n] || n,
                            oe.expr.match.bool.test(n) ? Ct && St || !kt.test(n) ? e[i] = !1 : e[oe.camelCase("default-" + n)] = e[i] = !1 : oe.attr(e, n, ""),
        ...
        Tt = {
            set: function(e, t, n) {
                return t === !1 ? oe.removeAttr(e, n) : Ct && St || !kt.test(n) ? e.setAttribute(!St && oe.propFix[n] || n, n) : e[oe.camelCase("default-" + n)] = e[n] = !0,
                    n
            }
        },
    ...
    oe.fn.extend({
        addClass: function(e) {
            ...
            if (c)
                for (t = (e || "").match(xe) || []; s < l; s++)
                    if (n = this[s],
                        i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Yt, " ") : " ")) {
                        for (o = 0; r = t[o++]; )
                            i.indexOf(" " + r + " ") < 0 && (i += r + " ");
                        a = oe.trim(i),
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    for (var t, i = 0, r = oe(this), o = e.match(xe) || []; t = o[i++]; )
                        r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                else
                    n !== Pe && "boolean" !== n || (this.className && oe._data(this, "__className__", this.className),
                        this.className = this.className || e === !1 ? "" : oe._data(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
            for (var t = " " + e + " ", n = 0, i = this.length; n < i; n++)
                if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(Yt, " ").indexOf(t) >= 0)
                    return !0;
            return !1
        }
    }),
    ...
    ;
    var Dt, It, Qt = /#.*$/, Ft = /([?&])_=[^&]*/, Lt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Ot = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Nt = /^(?:GET|HEAD)$/, Bt = /^\/\//, zt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Rt = {}, Ht = {}, qt = "*/".concat("*");
    try {
        It = location.href
    } catch (Wt) {
        ...
        oe.extend({
            ...
            ajax: function(e, t) {
                function n(e, t, n, i) {
                    ...
                    n && (g = z(p, _, n)),
                        g = R(p, g, _, r),
                        r ? (p.ifModified && (x = _.getResponseHeader("Last-Modified"),
                        ...
                        _.status = e,
                        _.statusText = (t || w) + "",
                        r ? h.resolveWith(d, [u, w, _]) : h.rejectWith(d, [_, w, v]),
                        _.statusCode(y),
                        y = void 0,
                    l && f.trigger(r ? "ajaxSuccess" : "ajaxError", [_, p, r ? u : v]),
                        m.fireWith(d, [_, w]),
                    l && (f.trigger("ajaxComplete", [_, p]),
                    --oe.active || oe.event.trigger("ajaxStop")))
                }
                "object" == typeof e && (t = e,
                    e = void 0),
                    t = t || {};
                var i, r, o, a, s, l, c, u, p = oe.ajaxSetup({}, t), d = p.context || p, f = p.context && (d.nodeType || d.jquery) ? oe(d) : oe.event, h = oe.Deferred(), m = oe.Callbacks("once memory"), y = p.statusCode || {}, v = {}, g = {}, b = 0, x = "canceled", _ = {
                    readyState: 0,
                ...
                if (h.promise(_).complete = m.add,
                    _.success = _.done,
                    _.error = _.fail,
                    p.url = ((e || p.url || It) + "").replace(Qt, "").replace(Bt, Dt[1] + "//"),
                    p.type = t.method || t.type || p.method || p.type,
                    p.dataTypes = oe.trim(p.dataType || "*").toLowerCase().match(xe) || [""],
                null == p.crossDomain && (i = zt.exec(p.url.toLowerCase()),
                ...
                l && 0 === oe.active++ && oe.event.trigger("ajaxStart"),
                    ...
                    o = p.url,
                p.hasContent || (p.data && (o = p.url += (At.test(o) ? "&" : "?") + p.data,
                    delete p.data),
                p.cache === !1 && (p.url = Ft.test(o) ? o.replace(Ft, "$1_=" + Et++) : o + (At.test(o) ? "&" : "?") + "_=" + Et++)),
                p.ifModified && (oe.lastModified[o] && _.setRequestHeader("If-Modified-Since", oe.lastModified[o]),
                oe.etag[o] && _.setRequestHeader("If-None-Match", oe.etag[o])),
                (p.data && p.hasContent && p.contentType !== !1 || t.contentType) && _.setRequestHeader("Content-Type", p.contentType),
                ...
                for (r in p.headers)
                    _.setRequestHeader(r, p.headers[r]);
                if (p.beforeSend && (p.beforeSend.call(d, _, p) === !1 || 2 === b))
                    return _.abort();
                x = "abort";
                for (r in {
                    success: 1,
        ...
        oe.ajaxPrefilter("json jsonp", function(t, n, i) {
            ...
            if (s || "jsonp" === t.dataTypes[0])
                return r = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                    s ? t[s] = t[s].replace(nn, "$1" + r) : t.jsonp !== !1 && (t.url += (At.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
    ...
    oe.offset = {
        setOffset: function(e, t, n) {
            var i, r, o, a, s, l, c, u = oe.css(e, "position"), p = oe(e), d = {};
            ...
            offset: function(e) {
                ...
                if (o)
                    return t = o.documentElement,
                        oe.contains(t, r) ? (typeof r.getBoundingClientRect !== Pe && (i = r.getBoundingClientRect()),
                            n = V(o),
                            {
    ...
    function(e) {
        ...
        e.fn.attr2 = function() {
            ...
            e.fn.ajaxSubmit = function(t) {
                ...
                function a(i) {
                    for (var r = new FormData, o = 0; o < i.length; o++)
                        r.append(i[o].name, i[o].value);
                    if (t.extraData) {
                        var a = n(t.extraData);
                        for (o = 0; o < a.length; o++)
                            a[o] && r.append(a[o][0], a[o][1])
                    }
                    t.data = null;
                ...
                function s(n) {
                    ...
                    function a() {
                        ...
                        T.setAttribute("target", h),
                        l && !/post/i.test(l) || T.setAttribute("method", "POST"),
                        o != d.url && T.setAttribute("action", d.url),
                        d.skipEncodingOverride || l && !/post/i.test(l) || p.attr({
                        ...
                        try {
                            if (d.extraData)
                                for (var f in d.extraData)
                                    d.extraData.hasOwnProperty(f) && (e.isPlainObject(d.extraData[f]) && d.extraData[f].hasOwnProperty("name") && d.extraData[f].hasOwnProperty("value") ? u.push(e('<input type="hidden" name="' + d.extraData[f].name + '">').val(d.extraData[f].value).appendTo(T)[0]) : u.push(e('<input type="hidden" name="' + f + '">').val(d.extraData[f]).appendTo(T)[0]));
                            d.iframeTarget || y.appendTo("body"),
                            ...
                            T.setAttribute("action", o),
                                T.setAttribute("enctype", c),
                                n ? T.setAttribute("target", n) : p.removeAttr("target"),
                                e(u).remove()
                        }
                    }
                    function s(t) {
                        if (!g.aborted && !E) {
                            if (Y = r(v),
                            Y || (i("cannot access response document"),
                                t = S),
                            t === k && g)
                                return g.abort("timeout"),
                                    void P.reject(g, "timeout");
                            if (t == S && g)
                                return g.abort("server abort"),
                                    void P.reject(g, "error", "server abort");
                            if (Y && Y.location.href != d.iframeSrc || _) {
                                ...
                                try {
                                    ...
                                    if (i("isXml=" + a),
                                    !a && window.opera && (null === Y.body || !Y.body.innerHTML) && --A)
                                        return i("requeing onLoad callback, DOM not available"),
                                            void setTimeout(s, 250);
                                    var l = Y.body ? Y.body : Y.documentElement;
                                    g.responseText = l ? l.innerHTML : null,
                                        g.responseXML = Y.XMLDocument ? Y.XMLDocument : Y,
                                    a && (d.dataType = "xml"),
                                        ...
                                        ,
                                    l && (g.status = Number(l.getAttribute("status")) || g.status,
                                        g.statusText = l.getAttribute("statusText") || g.statusText);
                                    ...
                                    if (u || d.textarea) {
                                        ...
                                        "xml" == c && !g.responseXML && g.responseText && (g.responseXML = M(g.responseText));
                                    try {
                                        $ = I(g, c, d)
                                    } catch (b) {
                                        o = "parsererror",
                                ...
                                g.aborted && (i("upload aborted"),
                                    o = null),
                                g.status && (o = g.status >= 200 && g.status < 300 || 304 === g.status ? "success" : "error"),
                                    "success" === o ? (d.success && d.success.call(d.context, $, "success", g),
                                        P.resolve(g.responseText, "success", g),
                                    f && e.event.trigger("ajaxSuccess", [g, d])) : o && (void 0 === n && (n = g.statusText),
                                    d.error && d.error.call(d.context, g, o, n),
                                        P.reject(g, "error", n),
                                    f && e.event.trigger("ajaxError", [g, d, n])),
                                f && e.event.trigger("ajaxComplete", [g, d]),
                                f && !--e.active && e.event.trigger("ajaxStop"),
                                d.complete && d.complete.call(d.context, g, o),
                                    E = !0,
                                d.timeout && clearTimeout(w),
                                    setTimeout(function() {
                                        d.iframeTarget ? y.attr("src", d.iframeSrc) : y.remove(),
                                            g.responseXML = null
                                    }, 100)
                            }
                        }
                    }
                    var c, u, d, f, h, y, v, g, b, x, _, w, T = p[0], P = e.Deferred();
                    ...
                    if (d = e.extend(!0, {}, e.ajaxSettings, t),
                        d.context = d.context || d,
                        h = "jqFormIO" + (new Date).getTime(),
                        d.iframeTarget ? (y = e(d.iframeTarget),
                            x = y.attr2("name"),
                            x ? h = x : y.attr2("name", h)) : (y = e('<iframe name="' + h + '" src="' + d.iframeSrc + '" />'),
                            y.css({
                                position: "absolute",
                                top: "-1000px",
                                left: "-1000px"
                        ...
                        g = {
                            ...
                            abort: function(t) {
                                ...
                                y.attr("src", d.iframeSrc),
                                    g.error = n,
                                d.error && d.error.call(d.context, g, n, t),
                                f && e.event.trigger("ajaxError", [g, d, n]),
                    ...
                    f && e.event.trigger("ajaxSend", [g, d]),
                    d.beforeSend && d.beforeSend.call(d.context, g, d) === !1)
                    ...
                    b = T.clk,
                    b && (x = b.name,
                    x && !b.disabled && (d.extraData = d.extraData || {},
                        d.extraData[x] = b.value,
                    "image" == b.type && (d.extraData[x + ".x"] = T.clk_x,
                        d.extraData[x + ".y"] = T.clk_y)));
                    var k = 1
                        , S = 2
                        , C = e("meta[name=csrf-token]").attr("content")
                        , j = e("meta[name=csrf-param]").attr("content");
                    j && C && (d.extraData = d.extraData || {},
                        d.extraData[j] = C),
                        d.forceSync ? a() : setTimeout(a, 10);
                    var $, Y, E, A = 50, M = e.parseXML || function(e, t) {
                        ...
                        "string" == typeof a && ("json" === n || !n && r.indexOf("json") >= 0 ? a = D(a) : ("script" === n || !n && r.indexOf("javascript") >= 0) && e.globalEval(a)),
                            a
                    };
                    return P
                }
                ...
                var d = {};
                if (this.trigger("form-pre-serialize", [this, t, d]),
                    d.veto)
                ...
                t.beforeSubmit && t.beforeSubmit(y, this, t) === !1)
                    return i("ajaxSubmit: submit aborted via beforeSubmit callback"),
                        this;
                if (this.trigger("form-submit-validate", [y, this, t, d]),
                    d.veto)
                ...
                if (t.success = function(e, n, i) {
                    for (var r = t.context || this, o = 0, a = g.length; o < a; o++)
                        g[o].apply(r, [e, n, i || p, p])
                }
                    ,
                    t.error) {
                    var x = t.error;
            ...
            e.fn.ajaxForm = function(r) {
                if (r = r || {},
                    r.delegation = r.delegation && e.isFunction(e.fn.on),
                !r.delegation && 0 === this.length) {
                    var o = {
                        s: this.selector,
                        c: this.context
                    };
                    return !e.isReady && o.s ? (i("DOM not ready, queuing ajaxForm"),
                        e(function() {
                ...
                return r.delegation ? (e(document).off("submit.form-plugin", this.selector, t).off("click.form-plugin", this.selector, n).on("submit.form-plugin", this.selector, r, t).on("click.form-plugin", this.selector, r, n),
                    this) : this.ajaxFormUnbind().bind("submit.form-plugin", r, t).bind("click.form-plugin", r, n)
            }
            ,
            ...
            e.fn.formToArray = function(t, n) {
                ...
                if (0 === this.length)
                    return i;
                var o, a = this[0], s = this.attr("id"), l = t ? a.getElementsByTagName("*") : a.elements;
                if (l && !/MSIE [678]/.test(navigator.userAgent) && (l = e(l).get()),
                s && (o = e(":input[form=" + s + "]").get(),
                ...
                for (c = 0,
                    ...
                    p && !f.disabled)
                        ...
                        d && d.constructor == Array)
                            ...
                            null !== d && "undefined" != typeof d && (n && n.push(f),
                                i.push({
                                    name: p,
                                    value: d,
                                    type: f.type,
                ...
                if (!t && a.clk) {
                    var v = e(a.clk)
                        , g = v[0];
                    p = g.name,
                    p && !g.disabled && "image" == g.type && (i.push({
                        name: p,
                        value: v.val()
                    }),
                        i.push({
                ...
                return this.each(function() {
                    ...
                    if (i) {
                        ...
                        if (r && r.constructor == Array)
                            ...
                            null !== r && "undefined" != typeof r && n.push({
                                name: this.name,
                                value: r
                            })
                    }
            ...
            e.fieldValue = function(t, n) {
                ...
                if (void 0 === n && (n = !0),
                n && (!i || t.disabled || "reset" == r || "button" == r || ("checkbox" == r || "radio" == r) && !t.checked || ("submit" == r || "image" == r) && t.form && t.form.clk != t || "select" == o && t.selectedIndex == -1))
                    return null;
                if ("select" == o) {
                    ...
                    for (var s = [], l = t.options, c = "select-one" == r, u = c ? a + 1 : l.length, p = c ? a : 0; p < u; p++) {
                        ...
                        if (d.selected) {
                            var f = d.value;
                            if (f || (f = d.attributes && d.attributes.value && !d.attributes.value.specified ? d.text : d.value),
                                c)
                                return f;
                            s.push(f)
                        }
    ...
    function(e, t, n, i) {
        ...
        function a(e, t) {
            var n = b["on" + e];
            n && (w(n) ? n.call(t[0]) : (n.addClass && t.addClass(n.addClass),
        ...
        function l(n) {
            if (S.length) {
                n = n || b.forceLoad,
                    C = 1 / 0;
                var i, r, l = o(), c = t.innerHeight || v.clientHeight, u = t.innerWidth || v.clientWidth;
                for (i = 0,
                         r = S.length; i < r; i++) {
                    var p, d = S[i], h = d[0], y = d[f], g = !1, x = n;
                    if (k(v, h)) {
                        if (n || !y.visibleOnly || h.offsetWidth || h.offsetHeight) {
                            if (!x) {
                                var _ = h.getBoundingClientRect()
                                    ...
                                    , P = y.edgeY;
                                p = _.top + l - P - c,
                                    x = p <= l && _.bottom > -P && _.left <= u + T && _.right > -T
                            }
                            if (x) {
                                a("show", d);
                                var j = y.srcAttr
        ...
        function c() {
            j > 1 ? (j = 1,
                l(),
                setTimeout(c, b.throttle)) : j = 0
        }
        function u(e) {
            S.length && (e && "scroll" === e.type && e.currentTarget === t && C >= o() || (j || setTimeout(c, 0),
                j = 2))
        }
        function p() {
            _.lazyLoadXT()
        ...
        e[f] = T(b, x, e[f]),
            e.fn[f] = function(n) {
                n = n || {};
                var i, o = r(n, "blankImage"), s = r(n, "checkDuplicates"), l = r(n, "scrollContainer"), c = {};
                e(l).on("scroll", u);
                for (i in x)
                    c[i] = r(n, i);
            ...
            e(n).ready(function() {
                a("start", _),
                    _.on(b.loadEvent, p).on(b.updateEvent, u).on(b.forceEvent, d),
                    e(n).on(b.updateEvent, u),
                b.autoInit && p()
            })
    ...
    function(e) {
        ...
        var r = function(e, t) {
            ...
            var n = e.length - 1
                , i = t(e[n]);
            return e[n] = t(parseInt(i, 10).toString()),
                e
        };
        e.animateNumber = {
            numberStepFactories: {
            ...
            e.fn.animateNumber = function() {
                for (var t = arguments[0], i = e.extend({}, n, t), r = e(this), o = [i], a = 1, s = arguments.length; a < s; a++)
                    o.push(arguments[a]);
                if (t.numberStep) {
    ...
    function() {
        ...
        function o(e) {
            var t = -1
                ...
                , o = e[i / 2 | 0]
                , a = e[i - 1];
            if (r && "object" == typeof r && o && "object" == typeof o && a && "object" == typeof a)
                return !1;
            var s = l();
        ...
        function d(n) {
            ...
            function V(e, t, n, i, r) {
                ...
                if (t) {
                    ...
                    o = d ? p(e) : oi({}, e);
                return d && (Dn.call(e, "index") && (o.index = e.index),
                Dn.call(e, "input") && (o.input = e.input)),
                    t ? (i.push(e),
                        r.push(o),
                        (d ? Ge : li)(e, function(e, a) {
                            o[a] = V(e, t, n, i, r)
                        }),
                    f && (c(i),
                        c(r)),
            ...
            function G(e, t, n) {
                ...
                if ("undefined" == typeof i && (Gn.funcNames && (i = !e.name),
                    i = i || !Gn.funcDecomp,
                    !i)) {
                    var r = An.call(e);
                    Gn.funcNames || (i = !S.test(r)),
                    i || (i = Y.test(r),
                        Zn(e, i))
                }
                if (i === !1 || i !== !0 && 1 & i[1])
            ...
            function Z(e) {
                function t() {
                    ...
                    if ((o || u) && (h || (h = p(arguments)),
                    o && In.apply(h, o),
                    u && h.length < s))
                        return i |= 16,
                            Z([n, d ? i : i & -4, h, null, a, s]);
                    if (h || (h = arguments),
                    c && (n = e[f]),
                    this instanceof t) {
                        e = U(n.prototype);
            ...
            function te(e, t, n, i, r, o) {
                ...
                if (!f) {
                    ...
                    if (h || m)
                        return te(h ? e.__wrapped__ : e, m ? t.__wrapped__ : t, n, i, r, o);
                    if (p != N)
                        return !1;
                    var y = e.constructor
                        , v = t.constructor;
                    if (y != v && !($e(y) && y instanceof y && $e(v) && v instanceof v) && "constructor"in e && "constructor"in t)
                        return !1
                }
                var g = !r;
                r || (r = s()),
                ...
                if (a = !0,
                    ...
                    si(t, function(t, s, l) {
                        if (Dn.call(l, s))
                            return x++,
                                a = Dn.call(e, s) && te(e[s], t, n, i, r, o)
                    }),
            ...
            function re(n, i, r) {
                ...
                for (; ++a < p; ) {
                    var y = n[a]
                        , v = r ? r(y, a, n) : y;
                    (i ? !a || h[h.length - 1] !== v : l(h, v) < 0) && ((r || f) && h.push(v),
                        d.push(y))
                }
                return f ? (c(h.array),
                    u(h)) : r && c(h),
            ...
            function ae(e, t, n, i, r, o) {
                ...
                if (d && d !== !0)
                    ...
                    !a && 1 & d[1] && (t |= 8),
                    !l || 4 & d[1] || (d[5] = o),
                    c && In.apply(d[2] || (d[2] = []), n),
                    u && Ln.apply(d[3] || (d[3] = []), i),
                        d[1] |= t,
                        ae.apply(null, d);
                var f = 1 == t || 17 === t ? b : Z;
            ...
            function ue(e) {
                var t, n;
                return !!(e && Cn.call(e) == N && (t = e.constructor,
                !$e(t) || t instanceof t)) && (si(e, function(e, t) {
                    n = t
                }),
            ...
            function fe(e, t, n, i) {
                return "boolean" != typeof t && null != t && (i = n,
                    n = t,
                    t = !1),
                    V(e, t, "function" == typeof n && G(n, i, 1))
            }
            function he(e, t, n) {
            ...
            function Le(e) {
                ...
                for (var r = p(arguments, 1, n), o = -1, a = s(), l = s(); ++o < n; )
                    ne(e, r[o], i, a, l);
                return c(a),
                    c(l),
                    e
            ...
            function ze(e, t, n, i) {
                ...
                return t && (t = h.createCallback(t, i, 4),
                    (r ? Ge : li)(e, function(e, i, r) {
                        return t(n, e, i, r)
                    })),
                    n
            }
            ...
            function He(e) {
                for (var t = arguments, n = -1, i = ee(t, !0, !1, 1), r = t[2] && t[2][t[1]] === e ? 1 : i.length, o = hn(r); ++n < r; )
                    o[n] = e[i[n]];
                return o
            }
            function qe(e, t, n) {
                var i = -1
                    ...
                    , o = e ? e.length : 0
                    , a = !1;
                return n = (n < 0 ? qn(0, o + n) : n) || 0,
                    Kn(e) ? a = r(e, t, n) > -1 : "number" == typeof o ? a = (Ie(e) ? e.indexOf(t, n) : r(e, t, n)) > -1 : li(e, function(e) {
                        if (++i >= n)
                            return !(a = e === t)
                    }),
                    a
            ...
            function Ge(e, t, n) {
                var i = -1
                    , r = e ? e.length : 0;
                if (t = t && "undefined" == typeof n ? t : G(t, n, 3),
                "number" == typeof r)
                    for (; ++i < r && t(e[i], i, e) !== !1; )
                        ;
                else
            ...
            function et(e, t, n) {
                ...
                null == t && Kn(e))
                    ...
                    t = null == t && Ie(e) ? i : h.createCallback(t, n, 3),
                        Ge(e, function(e, n, i) {
                            var a = t(e, n, i);
                            a > r && (r = a,
                                o = e)
            ...
            function it(e, t, n, i) {
                var r = arguments.length < 3;
                return t = h.createCallback(t, i, 4),
                    Ze(e, function(e, i, o) {
                        n = r ? (r = !1,
                            e) : t(n, e, i, o)
                    }),
            ...
            function ot(e, t, n) {
                if (e && "number" != typeof e.length && (e = Re(e)),
                null == t || n)
                    return e ? e[ie(0, e.length - 1)] : f;
                var i = at(e);
                return i.length = Wn(qn(0, t), i.length),
                    i
            }
            function at(e) {
                var t = -1
            ...
            function mt(e, t, n) {
                ...
                if ("number" != typeof t && null != t) {
                    var o = -1;
                    for (t = h.createCallback(t, n, 3); ++o < r && t(e[o], o, e); )
                        i++
                } else if (i = t,
                null == i || n)
                    return e ? e[0] : f;
            ...
            function Tt(e, t, n) {
                ...
                null == t && (t = e,
                    e = 0);
                for (var i = -1, r = qn(0, $n((t - e) / (n || 1))), o = hn(r); ++i < r; )
                    o[i] = e,
                        e += n;
                return o
            }
            ...
            function kt(e, t, n) {
                if ("number" != typeof t && null != t) {
                    var i = 0
                        , r = -1
                        , o = e ? e.length : 0;
                    for (t = h.createCallback(t, n, 3); ++r < o && t(e[r], r, e); )
                        i++
                } else
                    i = null == t || n ? 1 : qn(0, t);
                return p(e, i)
            ...
            function St(e, t, n, i) {
                var r = 0
                    , o = e ? e.length : r;
                for (n = n ? h.createCallback(n, i, 1) : Zt,
                         t = n(t); r < o; ) {
                    var a = r + o >>> 1;
                    n(e[a]) < t ? r = a + 1 : o = a
                }
            ...
            function jt(e, t, n, i) {
                return "boolean" != typeof t && null != t && (i = n,
                    n = "function" != typeof t && i && i[t] === e ? null : t,
                    t = !1),
                null != n && (n = h.createCallback(n, i, 3)),
                    re(e, t, n)
            }
            function $t(e) {
            ...
            function Yt() {
                for (var e = -1, t = arguments.length; ++e < t; ) {
                    var n = arguments[e];
                    if (Kn(n) || de(n))
                        var i = i ? re(K(i, n).concat(K(n, i))) : n
                }
                return i || []
            }
            function Et() {
                for (var e = arguments.length > 1 ? arguments : arguments[0], t = -1, n = e ? et(fi(e, "length")) : 0, i = hn(n < 0 ? 0 : n); ++t < n; )
                    i[t] = fi(e, t);
                return i
            }
            function At(e, t) {
            ...
            function Ot(e, t, n) {
                ...
                return function() {
                    ...
                    p === !1)
                        ...
                        v ? (r && (r = Yn(r)),
                            u = a,
                            o = e.apply(s, i)) : r || (r = Qn(y, f))
                    }
                    return v && l ? l = Yn(l) : l || t === p || (l = Qn(m, t)),
                    n && (v = !0,
                        o = e.apply(s, i)),
                    !v || l || r || (i = s = null),
                        o
            ...
            function Wt(e, t, n) {
                ...
                if (!$e(e))
                    throw new Tn;
                return n === !1 ? i = !1 : Ye(n) && (i = "leading"in n ? n.leading : i,
            ...
            function Kt(e, t, n) {
                ...
                t && (n || r.length) || (null == n && (n = t),
                    ...
                    e = h,
                    r = xe(t)),
                    n === !1 ? i = !1 : Ye(n) && "chain"in n && (i = n.chain);
                var o = e
                    , a = $e(o);
                Ge(r, function(n) {
                    var r = e[n] = t[n];
            ...
            function nn(e, t, n) {
                var i = null == e
                    , r = null == t;
                if (null == n && ("boolean" == typeof e && r ? (n = e,
            ...
            function on(e, t, n) {
                ...
                e = wn(e || ""),
                    n = ai({}, n, i);
                var r, o = ai({}, n.imports, i.imports), s = ei(o), l = Re(o), c = 0, u = n.interpolate || $, p = "__p += '", d = _n((n.escape || $).source + "|" + u.source + "|" + (u === C ? P : $).source + "|" + (n.evaluate || $).source + "|$", "g");
                e.replace(d, function(t, n, i, o, s, l) {
                    return i || (i = o),
                        p += e.slice(c, l).replace(E, a),
                    n && (p += "' +\n__e(" + n + ") +\n'"),
                    s && (r = !0,
                        p += "';\n" + s + ";\n__p += '"),
                    i && (p += "' +\n((__t = (" + i + ")) == null ? '' : __t) +\n'"),
                ...
                y || (m = "obj",
                    p = "with (" + m + ") {\n" + p + "\n}\n"),
                    p = (r ? p.replace(_, "") : p).replace(w, "$1").replace(T, "$1;"),
            ...
            var Gn = h.support = {};
            Gn.funcDecomp = !ce(n.WinRTError) && Y.test(d),
                Gn.funcNames = "string" == typeof vn.name,
                h.templateSettings = {
                    escape: /<%-([\s\S]+?)%>/g,
                    evaluate: /<%([\s\S]+?)%>/g,
                    interpolate: C,
            ...
            var Zn = On ? function(e, t) {
                ...
                , oi = function(e, t, n) {
                    ...
                    if (l > 3 && "function" == typeof a[l - 2])
                        var c = G(a[--l - 1], a[l--], 2);
                    else
                        l > 2 && "function" == typeof a[l - 1] && (c = a[--l]);
                    for (; ++s < l; )
                        if (r = a[s],
                        r && W[typeof r])
                            for (var u = -1, p = W[typeof r] && ei(r), d = p ? p.length : 0; ++u < d; )
                                i = p[u],
                                    o[i] = c ? c(o[i], r[i]) : r[i];
                    return o
                }
                , ai = function(e, t, n) {
                    ...
                    for (var a = arguments, s = 0, l = "number" == typeof n ? 2 : a.length; ++s < l; )
                        if (r = a[s],
                        r && W[typeof r])
                            for (var c = -1, u = W[typeof r] && ei(r), p = u ? u.length : 0; ++c < p; )
                                i = u[c],
                                "undefined" == typeof o[i] && (o[i] = r[i]);
                    return o
                }
                , si = function(e, t, n) {
                    var i, r = e, o = r;
            ...
            return h.after = Mt,
                ...
                h.VERSION = "2.4.1",
                h.prototype.chain = pn,
                h.prototype.toString = dn,
                h.prototype.value = fn,
                h.prototype.valueOf = fn,
        ...
        var f, h = [], m = [], y = 0, v = +new Date + "", g = 75, b = 40, x = " \t\x0B\f \ufeff\n\r\u2028\u2029 ᠎             　", _ = /\b__p \+= '';/g, w = /\b(__p \+=) '' \+/g, T = /(__e\(.*?\)|\b__t\)) \+\n'';/g, P = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, k = /\w*$/, S = /^\s*function[ \n\r\t]+\w/, C = /<%=([\s\S]+?)%>/g, j = RegExp("^[" + x + "]*0+(?=.$)"), $ = /($^)/, Y = /\bthis\b/, E = /['\n\r\t\u2028\u2029\\]/g, A = ["Array", "Boolean", "Date", "Function", "Math", "Number", "Object", "RegExp", "String", "_", "attachEvent", "clearTimeout", "isFinite", "isNaN", "parseInt", "setTimeout"], M = 0, D = "[object Arguments]", I = "[object Array]", Q = "[object Boolean]", F = "[object Date]", L = "[object Function]", O = "[object Number]", N = "[object Object]", B = "[object RegExp]", z = "[object String]", R = {};
        R[L] = !1,
            R[D] = R[I] = R[Q] = R[F] = R[O] = R[N] = R[B] = R[z] = !0;
        var H = {
            leading: !1,
            maxWait: 0,
            trailing: !1
    ...
    window.Modernizr = function(e, t, n) {
        ...
        function s(e, t, i) {
            for (var o in e) {
                var a = t[e[o]];
                if (a !== n)
                    return i === !1 ? e[o] : r(a, "function") ? a.bind(i || t) : a
            }
            return !1
        }
        function l(e, t, n) {
            ...
            return r(t, "string") || r(t, "undefined") ? a(o, t) : (o = (e + " " + x.join(i + " ") + i).split(" "),
                s(o, t, n))
        }
        var c, u, p, d = "2.8.3", f = {}, h = t.documentElement, m = "modernizr", y = t.createElement(m), v = y.style, g = ({}.toString,
            "Webkit Moz O ms"), b = g.split(" "), x = g.toLowerCase().split(" "), _ = {}, w = [], T = w.slice, P = {}.hasOwnProperty;
                ...
                e.prototype.createEvent = function(e, t, n, i) {
                    ...
                    null == i && (i = null),
                        null != document.createEvent ? (r = document.createEvent("CustomEvent"),
                            r.initCustomEvent(e, t, n, i)) : null != document.createEventObject ? (r = document.createEventObject(),
                            ...
                            r = t[n],
                                ...
                                i.push(function() {
                                    ...
                                    for (a = this.vendors,
                                             ...
                                             i = a.length; t < i; t++)
                                        o = a[t],
                                            s.push(e["" + o + n.charAt(0).toUpperCase() + n.substr(1)] = r);
                                    return s
                                }
                                    .call(this));
                        return i
    ...
    function(e, t) {
        ...
        var t, n = {}, i = "undefined" != typeof window ? window : global, r = i.document, o = "localStorage", a = "script";
        if (n.disabled = !1,
            n.version = "1.3.20",
            n.set = function(e, t) {}
            ,
            ...
            try {
                l = new ActiveXObject("htmlfile"),
                    l.open(),
                    l.write("<" + a + ">document.w=window</" + a + '><iframe src="/favicon.ico"></iframe>'),
                    l.close(),
    ...
    function(e, t, n, i) {
        ...
        function r(e, t) {
            ...
            e && e.isDefaultPrevented() || (e.preventDefault(),
                ...
                r = i.attr("data-fancybox") || "",
                r ? (o = t.selector ? n(t.selector) : e.data ? e.data.items : [],
                    o = o.length ? o.filter('[data-fancybox="' + r + '"]') : n('[data-fancybox="' + r + '"]'),
                    a = o.index(i),
                a < 0 && (a = 0)) : o = [i],
                n.fancybox.open(o, t, a))
        }
        if (e.console = e.console || {
            ...
            var o = {
                ...
                , p = function() {
                var e, n = t.createElement("fakeelement"), r = {
                ...
                n.isPlainObject(i) && (o.opts = f(o.opts, i)),
                n.fancybox.isMobile && (o.opts = f(o.opts, o.opts.mobile)),
                    ...
                    o.slides = {},
                    o.addContent(e),
                o.group.length && (o.$lastFocus = n(t.activeElement).trigger("blur"),
                    o.init())
            };
            n.extend(h.prototype, {
                init: function() {
                    var r, o, a, s = this, l = s.group[s.currIndex], c = l.opts, u = n.fancybox.scrollbarWidth;
                    n.fancybox.getInstance() || c.hideScrollbar === !1 || (n("body").addClass("fancybox-active"),
                    !n.fancybox.isMobile && t.body.scrollHeight > e.innerHeight && (u === i && (r = n('<div style="width:100px;height:100px;overflow:scroll;" />').appendTo("body"),
                        u = n.fancybox.scrollbarWidth = r[0].offsetWidth - r[0].clientWidth,
                        r.remove()),
                        n("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar { margin-right: ' + u + "px; }</style>"),
                        n("body").addClass("compensate-for-scrollbar"))),
                        a = "",
                        n.each(c.buttons, function(e, t) {
                            a += c.btnTpl[t] || ""
                        }),
                        o = n(s.translate(s, c.baseTpl.replace("{{buttons}}", a).replace("{{arrows}}", c.btnTpl.arrowLeft + c.btnTpl.arrowRight))).attr("id", "fancybox-container-" + s.id).addClass("fancybox-is-hidden").addClass(c.baseClass).data("FancyBox", s).appendTo(c.parentEl),
                        s.$refs = {
                            container: o
                        },
                ...
                addContent: function(e) {
                    var t, r = this, o = n.makeArray(e);
                    n.each(o, function(e, t) {
                        var o, a, s, l, c, u = {}, p = {};
                        n.isPlainObject(t) ? (u = t,
                            p = t.opts || t) : "object" === n.type(t) && n(t).length ? (o = n(t),
                            p = o.data() || {},
                            p = n.extend(!0, {}, p, p.options),
                            p.$orig = o,
                            u.src = r.opts.src || p.src || o.attr("href"),
                        u.type || u.src || (u.type = "inline",
                            u.src = t)) : u = {
                            type: "html",
                            src: t + ""
                        },
                            u.opts = n.extend(!0, {}, r.opts, p),
                        n.isArray(p.buttons) && (u.opts.buttons = p.buttons),
                            a = u.type || u.opts.type,
                            l = u.src || "",
                        !a && l && ((s = l.match(/\.(mp4|mov|ogv)((\?|#).*)?$/i)) ? (a = "video",
                        u.opts.videoFormat || (u.opts.videoFormat = "video/" + ("ogv" === s[1] ? "ogg" : s[1]))) : l.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? a = "image" : l.match(/\.(pdf)((\?|#).*)?$/i) ? a = "iframe" : "#" === l.charAt(0) && (a = "inline")),
                            a ? u.type = a : r.trigger("objectNeedsType", u),
                        ...
                        u.opts.$trigger && u.index === r.opts.index && (u.opts.$thumb = u.opts.$trigger.find("img:first")),
                        ...
                        s.on("keydown.fb", function(e) {
                            ...
                            if (t && t.opts.keyboard && !(e.ctrlKey || e.altKey || e.shiftKey || n(e.target).is("input") || n(e.target).is("textarea")))
                                return 8 === r || 27 === r ? (e.preventDefault(),
                                    void i.close(e)) : 37 === r || 38 === r ? (e.preventDefault(),
                                    void i.previous()) : 39 === r || 40 === r ? (e.preventDefault(),
                                    void i.next()) : void i.trigger("afterKeydown", e, r)
                        }),
                ...
                jumpTo: function(e, t) {
                    var r, o, a, s, l, c, u, p = this, f = p.group.length;
                    if (!(p.isDragging || p.isClosing || p.isAnimating && p.firstRun)) {
                        if (e = parseInt(e, 10),
                            o = p.current ? p.current.opts.loop : p.opts.loop,
                        !o && (e < 0 || e >= f))
                            return !1;
                        if (r = p.firstRun = !Object.keys(p.slides).length,
                            !(f < 2 && !r && p.isDragging)) {
                            if (s = p.current,
                                p.prevIndex = p.currIndex,
                                p.prevPos = p.currPos,
                                a = p.createSlide(e),
                            f > 1 && ((o || a.index > 0) && p.createSlide(e - 1),
                            (o || a.index < f - 1) && p.createSlide(e + 1)),
                                p.current = a,
                                p.currIndex = a.index,
                                p.currPos = a.pos,
                                ...
                                t = parseInt(t, 10),
                                r)
                                return a.opts.animationEffect && t && p.$refs.container.css("transition-duration", t + "ms"),
                            ...
                            s.pos !== a.pos && (u = "fancybox-slide--" + (s.pos > a.pos ? "next" : "previous"),
                                ...
                                s.isComplete = !1,
                            t && (a.isMoved || a.opts.transitionEffect) && (a.isMoved ? s.$slide.addClass(u) : (u = "fancybox-animated " + u + " fancybox-fx-" + a.opts.transitionEffect,
                                n.fancybox.animate(s.$slide, u, t, function() {
                ...
                createSlide: function(e) {
                    var t, i, r = this;
                    return i = e % r.group.length,
                        i = i < 0 ? r.group.length + i : i,
                    !r.slides[e] && r.group[i] && (t = n('<div class="fancybox-slide"></div>').appendTo(r.$refs.stage),
                        r.slides[e] = n.extend(!0, {}, r.group[i], {
                            pos: e,
                            $slide: t,
                            isLoaded: !1
                        }),
                        r.updateSlide(r.slides[e])),
                        r.slides[e]
                },
                scaleToActual: function(e, t, r) {
                    var o, a, s, l, c, u = this, p = u.current, d = p.$content, f = n.fancybox.getTranslate(p.$slide).width, h = n.fancybox.getTranslate(p.$slide).height, m = p.width, y = p.height;
                    !u.isAnimating && d && "image" == p.type && p.isLoaded && !p.hasError && (n.fancybox.stop(d),
                        u.isAnimating = !0,
                        e = e === i ? .5 * f : e,
                        t = t === i ? .5 * h : t,
                        o = n.fancybox.getTranslate(d),
                        o.top -= n.fancybox.getTranslate(p.$slide).top,
                        o.left -= n.fancybox.getTranslate(p.$slide).left,
                        l = m / o.width,
                        c = y / o.height,
                        a = .5 * f - .5 * m,
                        s = .5 * h - .5 * y,
                    m > f && (a = o.left * l - (e * l - e),
                    a > 0 && (a = 0),
                    a < f - m && (a = f - m)),
                    y > h && (s = o.top * c - (t * c - t),
                    s > 0 && (s = 0),
                ...
                scaleToFit: function(e) {
                    var t, i = this, r = i.current, o = r.$content;
                    !i.isAnimating && o && "image" == r.type && r.isLoaded && !r.hasError && (n.fancybox.stop(o),
                        i.isAnimating = !0,
                        t = i.getFitPos(r),
                ...
                getFitPos: function(e) {
                    var t, n, i, r, o, a = this, s = e.$content, l = e.width || e.opts.width, c = e.height || e.opts.height, u = {};
                    return !!(e.isLoaded && s && s.length) && (r = {
                        ...
                        t = parseInt(a.$refs.stage.width(), 10) - (r.left + r.right),
                        n = parseInt(a.$refs.stage.height(), 10) - (r.top + r.bottom),
                    l && c || (l = t,
                        c = n),
                        i = Math.min(1, t / l, n / c),
                        l = Math.floor(i * l),
                        c = Math.floor(i * c),
                        "image" === e.type ? (u.top = Math.floor(.5 * (n - c)) + r.top,
                            u.left = Math.floor(.5 * (t - l)) + r.left) : "video" === e.contentType && (o = e.opts.width && e.opts.height ? l / c : e.opts.ratio || 16 / 9,
                            c > l / o ? c = l / o : l > c * o && (l = c * o)),
                        u.width = l,
                        u.height = c,
                        u)
                },
                ...
                updateSlide: function(e, t) {
                    ...
                    r && (o || a || "video" === e.contentType) && !e.hasError && (n.fancybox.stop(r),
                        n.fancybox.setTranslate(r, i.getFitPos(e)),
                ...
                centerSlide: function(e, t) {
                    var r, o, a = this;
                    a.current && (r = Math.round(e.$slide.width()),
                        o = e.pos - a.current.pos,
                ...
                updateCursor: function(e, t) {
                    var i, r = this, o = r.current, a = r.$refs.container.removeClass("fancybox-is-zoomable fancybox-can-zoomIn fancybox-can-drag fancybox-can-zoomOut");
                    o && !r.isClosing && (i = r.isZoomable(),
                        a.toggleClass("fancybox-is-zoomable", i),
                        n("[data-fancybox-zoom]").prop("disabled", !i),
                        i && ("zoom" === o.opts.clickContent || n.isFunction(o.opts.clickContent) && "zoom" === o.opts.clickContent(o)) ? r.isScaledDown(e, t) ? a.addClass("fancybox-can-zoomIn") : o.opts.touch ? a.addClass("fancybox-can-drag") : a.addClass("fancybox-can-zoomOut") : o.opts.touch && "video" !== o.contentType && a.addClass("fancybox-can-drag"))
                },
                isZoomable: function() {
                ...
                isScaledDown: function(e, t) {
                    var r = this
                        ...
                        , a = r.current
                        , s = a.$content;
                    return e !== i && t !== i ? o = e < a.width && t < a.height : s && (o = n.fancybox.getTranslate(s),
                ...
                loadSlide: function(e) {
                    ...
                    if (!e.isLoading && !e.isLoaded) {
                        switch (e.isLoading = !0,
                            ...
                            case "ajax":
                                o.showLoading(e),
                                    r = n.ajax(n.extend({}, e.opts.ajax.settings, {
                                        url: e.src,
                ...
                setImage: function(t) {
                    var i, r, o, a, s, l = this, c = t.opts.srcset || t.opts.image.srcset;
                    if (t.timouts = setTimeout(function() {
                        ...
                        !r && o.length && (r = o[o.length - 1]),
                        r && (t.src = r.url,
                        t.width && t.height && "w" == r.postfix && (t.height = t.width / t.height * r.value,
                            t.width = r.value),
                            t.opts.srcset = c)
                    }
                ...
                setBigImage: function(e) {
                    ...
                    e.$image = i.one("error", function() {
                        ...
                        n && "auto" !== n || (n = (e.width / e.height > 1 && a.width() / a.height() > 1 ? "100" : Math.round(e.width / e.height * 100)) + "vw"),
                ...
                resolveImageSlideSize: function(e, t, n) {
                    ...
                    r > 0 && (e.width = Math.floor(r * t / n),
                        e.height = r)
                },
                setIframe: function(e) {
                    var t, r = this, o = e.opts.iframe, a = e.$slide;
                    e.$content = n('<div class="fancybox-content' + (o.preload ? " fancybox-is-hidden" : "") + '"></div>').css(o.css).appendTo(a),
                        a.addClass("fancybox-slide--" + e.contentType),
                        e.$iframe = t = n(o.tpl.replace(/\{rnd\}/g, (new Date).getTime())).attr(o.attr).appendTo(e.$content),
                        o.preload ? (r.showLoading(e),
                            ...
                            a.on("refresh.fb", function() {
                                var n, r, a = e.$content, s = o.css.width, l = o.css.height;
                                if (1 === t[0].isReady) {
                                    try {
                                        n = t.contents(),
                                            r = n.find("body")
                                    ...
                                    s === i && (s = Math.ceil(Math.max(r[0].clientWidth, r.outerWidth(!0)))),
                                    s && a.width(s),
                                    l === i && (l = Math.ceil(Math.max(r[0].clientHeight, r.outerHeight(!0)))),
                                    l && a.height(l)),
                ...
                setContent: function(e, t) {
                    ...
                    e.$content && n.fancybox.stop(e.$content),
                        e.$slide.empty(),
                        c(t) && t.parent().length ? (t.parent().parent(".fancybox-slide--inline").trigger("onReset"),
                ...
                revealContent: function(e) {
                    var t, r, o, a, s = this, l = e.$slide, c = !1, u = !1;
                    ...
                    "zoom" === t && (e.pos === s.currPos && o && "image" === e.type && !e.hasError && (u = s.getThumbPos(e)) ? c = s.getFitPos(e) : t = "fade"),
                        "zoom" === t ? (c.scaleX = c.width / u.width,
                            c.scaleY = c.height / u.height,
                            a = e.opts.zoomOpacity,
                        "auto" == a && (a = Math.abs(e.width / e.height - u.width / u.height) > .1),
                        a && (u.opacity = .1,
                            c.opacity = 1),
                            ...
                            t ? (n.fancybox.stop(l),
                                r = "fancybox-animated fancybox-slide--" + (e.pos >= s.prevPos ? "next" : "previous") + " fancybox-fx-" + t,
                                l.removeAttr("style").removeClass("fancybox-slide--current fancybox-slide--next fancybox-slide--previous").addClass(r),
                                e.$content.removeClass("fancybox-is-hidden"),
                                d(l),
                                void n.fancybox.animate(l, "fancybox-slide--current", o, function(t) {
                                    l.removeClass(r).removeAttr("style"),
                ...
                getThumbPos: function(i) {
                    var r, o = this, a = !1, s = i.opts.$thumb, l = s && s.length && s[0].ownerDocument === t ? s.offset() : 0, c = function(t) {
                        for (var i, r = t[0], o = r.getBoundingClientRect(), a = []; null !== r.parentElement; )
                            "hidden" !== n(r.parentElement).css("overflow") && "auto" !== n(r.parentElement).css("overflow") || a.push(r.parentElement.getBoundingClientRect()),
                                r = r.parentElement;
                    ...
                    return l && c(s) && (r = o.$refs.stage.offset(),
                        a = {
                ...
                close: function(e, t) {
                    var i, r, o, a, s, l, c, f = this, h = f.current, m = function() {
                        f.cleanUp(e)
                    };
                    return !f.isClosing && (f.isClosing = !0,
                        f.trigger("beforeClose", e) === !1 ? (f.isClosing = !1,
                            u(function() {
                                f.update()
                            }),
                            !1) : (f.removeEvents(),
                        h.timouts && clearTimeout(h.timouts),
                            ...
                            r = n.isNumeric(t) ? t : i ? h.opts.animationDuration : 0,
                            h.$slide.off(p).removeClass("fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"),
                            h.$slide.siblings().trigger("onReset").remove(),
                        r && f.$refs.container.removeClass("fancybox-is-open").addClass("fancybox-is-closing"),
                            f.hideLoading(h),
                            f.hideControls(),
                            f.updateCursor(),
                        "zoom" !== i || e !== !0 && o && r && "image" === h.type && !h.hasError && (c = f.getThumbPos(h)) || (i = "fade"),
                            "zoom" === i ? (n.fancybox.stop(o),
                                ...
                                s = h.opts.zoomOpacity,
                            "auto" == s && (s = Math.abs(h.width / h.height - c.width / c.height) > .1),
                            s && (c.opacity = 0),
                                n.fancybox.setTranslate(o, l),
                                d(o),
                                n.fancybox.animate(o, c, r, m),
                                !0) : (i && r ? e === !0 ? setTimeout(m, r) : n.fancybox.animate(h.$slide.removeClass("fancybox-slide--current"), "fancybox-animated fancybox-slide--previous fancybox-fx-" + i, r, m) : m(),
                                !0)))
                },
                cleanUp: function(e) {
                    var t, i = this, r = n("body");
                    ...
                    i.$lastFocus && i.current.opts.backFocus && i.$lastFocus.trigger("focus"),
                        ...
                        t ? t.activate() : (r.removeClass("fancybox-active compensate-for-scrollbar"),
                            n("#fancybox-style-noscroll").remove())
                },
                trigger: function(e, t) {
                    var i, r = Array.prototype.slice.call(arguments, 1), o = this, a = t && t.opts ? t : o.current;
                    return a ? r.unshift(a) : a = o,
                        r.unshift(o),
                    n.isFunction(a.opts[e]) && (i = a.opts[e].apply(a, r)),
                        i === !1 ? i : void ("afterClose" !== e && o.$refs ? o.$refs.container.trigger(e + ".fb", r) : s.trigger(e + ".fb", r))
                },
                updateControls: function(e) {
                    ...
                    t.isHiddenControls || t.isIdle || t.showControls(),
                        ...
                        o.find("[data-fancybox-prev]").toggleClass("disabled", !n.opts.loop && i <= 0),
                        o.find("[data-fancybox-next]").toggleClass("disabled", !n.opts.loop && i >= t.group.length - 1),
                    ...
                    animate: function(e, t, r, o, a) {
                        ...
                        n.isPlainObject(t) || e.removeAttr("style"),
                            ...
                            e.on(p, function(i) {
                                ...
                                s && n.fancybox.setTranslate(e, s),
                                    n.isPlainObject(t) ? a === !1 && e.removeAttr("style") : a !== !0 && e.removeClass(t),
                                n.isFunction(o) && o(i))
                            }),
                        n.isNumeric(r) && e.css("transition-duration", r + "ms"),
                            n.isPlainObject(t) ? (t.scaleX !== i && t.scaleY !== i && (s = n.extend({}, t, {
                ...
                ,
                s.on("click.fb-start", "[data-fancybox]", r),
                s.on("click.fb-start", "[data-trigger]", function(e) {
                    r(e, {
    ...
    function(e) {
        ...
        e(document).on("objectNeedsType.fb", function(i, r, o) {
            var a, s, l, c, u, p, d, f = o.src || "", h = !1;
            a = e.extend(!0, {}, n, o.opts.media),
                e.each(a, function(n, i) {
                    if (l = f.match(i.matcher)) {
                        ...
                        return c = e.extend(!0, {}, i.params, o.opts[n], p),
                            f = "function" === e.type(i.url) ? i.url.call(this, l, c, o) : t(i.url, l, c),
                            s = "function" === e.type(i.thumb) ? i.thumb.call(this, l, c, o) : t(i.thumb, l),
                            "youtube" === n ? f = f.replace(/&t=((\d+)m)?(\d+)s/, function(e, t, n, i) {
                ...
                "iframe" === h && (o.opts = e.extend(!0, o.opts, {
                    iframe: {
                        preload: !1,
                        attr: {
                            scrolling: "no"
        ...
        u.prototype.destroy = function() {
            ...
            u.prototype.ontouchstart = function(i) {
                var r = this
                    ...
                    , d = p.$content
                    , f = "touchstart" == i.type;
                if (f && r.$container.off("mousedown.fb.touch"),
                (!i.originalEvent || 2 != i.originalEvent.button) && l.length && !s(l) && !s(l.parent()) && (l.is("img") || !(i.originalEvent.clientX > l[0].clientWidth + l.offset().left))) {
                    if (!p || u.isAnimating || u.isClosing)
                        return i.stopPropagation(),
                            void i.preventDefault();
                    if (r.realPoints = r.startPoints = o(i),
                        ...
                        if (i.stopPropagation(),
                            ...
                            r.canvasWidth = Math.round(p.$slide[0].clientWidth),
                            r.canvasHeight = Math.round(p.$slide[0].clientHeight),
                            r.contentLastPos = null,
                            r.contentStartPos = n.fancybox.getTranslate(r.$content) || {
                                top: 0,
                                left: 0
                            },
                            r.sliderStartPos = r.sliderLastPos || n.fancybox.getTranslate(p.$slide),
                            ...
                            n(t).off(".fb.touch").on(f ? "touchend.fb.touch touchcancel.fb.touch" : "mouseup.fb.touch mouseleave.fb.touch", n.proxy(r, "ontouchend")).on(f ? "touchmove.fb.touch" : "mousemove.fb.touch", n.proxy(r, "ontouchmove")),
                        n.fancybox.isMobile && t.addEventListener("scroll", r.onscroll, !0),
                        !r.opts && !u.canPan() || !l.is(r.$stage) && !r.$stage.find(l).length)
                            return void (l.is(".fancybox-image") && i.preventDefault());
                        n.fancybox.isMobile && (c(l) || c(l.parent())) || i.preventDefault(),
                        (1 === r.startPoints.length || p.hasError) && (r.instance.canPan() ? (n.fancybox.stop(r.$content),
                            r.$content.css("transition-duration", ""),
                            r.isPanning = !0) : r.isSwiping = !0,
                            r.$container.addClass("fancybox-controls--isGrabbing")),
                        2 === r.startPoints.length && "image" === p.type && (p.isLoaded || p.$ghost) && (r.canTap = !1,
                            r.isSwiping = !1,
                            r.isPanning = !1,
                            r.isZooming = !0,
                            n.fancybox.stop(r.$content),
                            r.$content.css("transition-duration", ""),
                            r.centerPointStartX = .5 * (r.startPoints[0].x + r.startPoints[1].x) - n(e).scrollLeft(),
                            r.centerPointStartY = .5 * (r.startPoints[0].y + r.startPoints[1].y) - n(e).scrollTop(),
                            ...
                            r.startDistanceBetweenFingers = a(r.startPoints[0], r.startPoints[1]))
                    }
                }
            }
            ,
            ...
            u.prototype.ontouchmove = function(e) {
                var t = this
                    , i = n(e.target);
                return void 0 !== e.originalEvent.buttons && 0 === e.originalEvent.buttons ? void t.ontouchend(e) : t.isScrolling || !i.is(t.$stage) && !t.$stage.find(i).length ? void (t.canTap = !1) : (t.newPoints = o(e),
            ...
            u.prototype.onSwipe = function(t) {
                var o, a = this, s = a.isSwiping, l = a.sliderStartPos.left || 0;
                if (s !== !0)
                    "x" == s && (a.distanceX > 0 && (a.instance.group.length < 2 || 0 === a.instance.current.index && !a.instance.current.opts.loop) ? l += Math.pow(a.distanceX, .8) : a.distanceX < 0 && (a.instance.group.length < 2 || a.instance.current.index === a.instance.group.length - 1 && !a.instance.current.opts.loop) ? l -= Math.pow(-a.distanceX, .8) : l += a.distanceX),
                        a.sliderLastPos = {
                    ...
                    if (a.canTap = !1,
                        a.instance.group.length < 2 && a.opts.vertical ? a.isSwiping = "y" : a.instance.isDragging || a.opts.vertical === !1 || "auto" === a.opts.vertical && n(e).width() > 800 ? a.isSwiping = "x" : (o = Math.abs(180 * Math.atan2(a.distanceY, a.distanceX) / Math.PI),
                    ...
                    a.instance.isDragging = a.isSwiping,
                        ...
                        n.each(a.instance.slides, function(e, t) {
                            n.fancybox.stop(t.$slide),
                                ...
                                t.inTransition = !1,
                            t.pos === a.instance.current.pos && (a.sliderStartPos.left = n.fancybox.getTranslate(t.$slide).left - n.fancybox.getTranslate(a.instance.$refs.stage).left)
                        }),
            ...
            u.prototype.onPan = function() {
                var e = this;
                return a(e.newPoints[0], e.realPoints[0]) < (n.fancybox.isMobile ? 10 : 5) ? void (e.startPoints = e.newPoints) : (e.canTap = !1,
            ...
            u.prototype.limitMovement = function() {
                var e, t, n, i, r, o, a = this, s = a.canvasWidth, l = a.canvasHeight, c = a.distanceX, u = a.distanceY, p = a.contentStartPos, d = p.left, f = p.top, h = p.width, m = p.height;
                return r = h > s ? d + c : d,
                    o = f + u,
                ...
                c > 0 && r > e && (r = e - 1 + Math.pow(-e + d + c, .8) || 0),
                c < 0 && r < n && (r = n + 1 - Math.pow(n - d - c, .8) || 0),
                u > 0 && o > t && (o = t - 1 + Math.pow(-t + f + u, .8) || 0),
                u < 0 && o < i && (o = i + 1 - Math.pow(i - f - u, .8) || 0),
                    {
                        top: o,
                        left: r
                    }
            ...
            u.prototype.ontouchend = function(e) {
                ...
                i.requestId && (r(i.requestId),
                    ...
                    i.canTap ? i.onTap(e) : (i.speed = 366,
                        ...
                        void (l ? i.endPanning() : c ? i.endZooming() : i.endSwiping(s, u)))
            }
            ,
            u.prototype.endSwiping = function(e, t) {
                ...
                i.sliderLastPos = null,
                    "y" == e && !t && Math.abs(i.distanceY) > 50 ? (n.fancybox.animate(i.instance.current.$slide, {
                        ...
                        r = i.instance.close(!0, 200)) : "x" == e && i.distanceX > 50 && o > 1 ? r = i.instance.previous(i.speedX) : "x" == e && i.distanceX < -50 && o > 1 && (r = i.instance.next(i.speedX)),
                r !== !1 || "x" != e && "y" != e || (t || o < 2 ? i.instance.centerSlide(i.instance.current, 150) : i.instance.jumpTo(i.instance.current.index)),
                    i.$container.removeClass("fancybox-is-sliding")
            }
            ,
            u.prototype.endPanning = function() {
                var e, t, i, r = this;
                r.contentLastPos && (r.opts.momentum === !1 ? (e = r.contentLastPos.left,
                    t = r.contentLastPos.top) : (e = r.contentLastPos.left + r.velocityX * r.speed,
                    t = r.contentLastPos.top + r.velocityY * r.speed),
                    i = r.limitPosition(e, t, r.contentStartPos.width, r.contentStartPos.height),
                    i.width = r.contentStartPos.width,
                    i.height = r.contentStartPos.height,
                    n.fancybox.animate(r.$content, i, 330))
            }
            ,
            u.prototype.endZooming = function() {
                var e, t, i, r, o = this, a = o.instance.current, s = o.newWidth, l = o.newHeight;
                o.contentLastPos && (e = o.contentLastPos.left,
                    ...
                    s < o.canvasWidth && l < o.canvasHeight ? o.instance.scaleToFit(150) : s > a.width || l > a.height ? o.instance.scaleToActual(o.centerPointStartX, o.centerPointStartY, 150) : (i = o.limitPosition(e, t, s, l),
                        n.fancybox.setTranslate(o.$content, n.fancybox.getTranslate(o.$content)),
                        n.fancybox.animate(o.$content, i, 150)))
            }
            ,
            u.prototype.onTap = function(t) {
                var i, r = this, a = n(t.target), s = r.instance, l = s.current, c = t && o(t) || r.startPoints, u = c[0] ? c[0].x - n(e).scrollLeft() - r.stagePos.left : 0, p = c[0] ? c[0].y - n(e).scrollTop() - r.stagePos.top : 0, d = function(e) {
                    var i = l.opts[e];
                    if (n.isFunction(i) && (i = i.apply(s, [l, t])),
                        i)
                        switch (i) {
                            case "close":
                ...
                if ((!t.originalEvent || 2 != t.originalEvent.button) && (a.is("img") || !(u > a[0].clientWidth + a.offset().left))) {
                    ...
                    if (r.tapped) {
                        if (clearTimeout(r.tapped),
                            r.tapped = null,
                        Math.abs(u - r.tapX) > 50 || Math.abs(p - r.tapY) > 50)
                            return this;
                        d("dblclick" + i)
                    } else
                        r.tapX = u,
                            r.tapY = p,
                            l.opts["dblclick" + i] && l.opts["dblclick" + i] !== l.opts["click" + i] ? r.tapped = setTimeout(function() {
                                r.tapped = null,
                                    d("click" + i)
                            }, 500) : d("click" + i);
                    return this
        ...
        t.extend(n.prototype, {
            ...
            t(e).on({
                ...
                "afterKeydown.fb": function(n, i, r, o, a) {
                    var s = i && i.SlideShow;
                    !s || !r.opts.slideShow || 80 !== a && 32 !== a || t(e.activeElement).is("button,a,input") || (o.preventDefault(),
                        s.toggle())
                },
        ...
        t.extend(!0, t.fancybox.defaults, {
            ...
            t(e).on({
                ...
                "afterKeydown.fb": function(e, t, n, i, r) {
                    t && t.FullScreen && 70 === r && (i.preventDefault(),
                        t.FullScreen.toggle())
                },
    ...
    function(e, t) {
        ...
        t.extend(o.prototype, {
            ...
            create: function() {
                var e, i = this, o = i.instance, a = i.opts.parentEl, s = [];
                i.$grid || (i.$grid = t('<div class="' + n + " " + n + "-" + i.opts.axis + '"></div>').appendTo(o.$refs.container.find(a).addBack().filter(a)),
                ...
                i.$list || (i.$list = t("<ul>").appendTo(i.$grid)),
                    t.each(o.group, function(t, n) {
                        ...
                        e || "image" !== n.type || (e = n.src),
                            s.push('<li data-index="' + t + '" tabindex="0" class="' + r + '"' + (e && e.length ? ' style="background-image:url(' + e + ')" />' : "") + "></li>")
                    }),
            ...
            focus: function(e) {
                var t, n, r = this, o = r.$list, a = r.$grid;
                r.instance.current && (t = o.children().removeClass(i).filter('[data-index="' + r.instance.current.index + '"]').addClass(i),
                    n = t.position(),
                    "y" === r.opts.axis && (n.top < 0 || n.top > o.height() - t.outerHeight()) ? o.stop().animate({
    ...
    function(e, t) {
        ...
        t.extend(!0, t.fancybox.defaults, {
            ...
            t(e).on("click", "[data-fancybox-share]", function() {
                var e, i, r = t.fancybox.getInstance(), o = r.current || null;
                o && ("function" === t.type(o.opts.share.url) && (e = o.opts.share.url.apply(o, [r, o])),
                    i = o.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === o.type ? encodeURIComponent(o.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(e)).replace(/\{\{url_raw\}\}/g, n(e)).replace(/\{\{descr\}\}/g, r.$caption ? encodeURIComponent(r.$caption.text()) : ""),
                    t.fancybox.open({
                        src: r.translate(r, i),
                        type: "html",
                        opts: {
                ...
                n.fancybox.defaults.hash !== !1 && (n(e).on({
                    "onInit.fb": function(e, t) {
                        ...
                        t.group[t.currIndex].opts.hash !== !1 && (n = i(),
                            r = o(t),
                        r && n.gallery && r == n.gallery && (t.currIndex = n.index - 1))
                    },
                    "beforeShow.fb": function(n, i, r, a) {
                        var s;
                        r && r.opts.hash !== !1 && (s = o(i),
                        s && (i.currentHash = s + (i.group.length > 1 ? "-" + (r.index + 1) : ""),
    ...
    function(e, t) {
        function n() {
            function n(t) {
                ...
                if ([9, 13, 32, 27].indexOf(i) !== -1) {
                    ...
                    9 === i ? (r = o === -1 ? w : o === P.length - 1 ? P[0] : P[o + 1],
                        D(n),
                        r.focus(),
                        s(r, p.confirmButtonColor)) : (r = 13 === i || 32 === i ? o === -1 ? w : void 0 : 27 !== i || T.hidden || "none" === T.style.display ? void 0 : T,
                    void 0 !== r && M(r, n))
                }
            }
            function a(t) {
                ...
                case "object":
                    if (void 0 === arguments[0].title)
                        return e.console.error('Missing "title" argument!'),
                            !1;
                    p.title = arguments[0].title,
                        p.text = arguments[0].text || g.text,
                        p.type = arguments[0].type || g.type,
                        p.customClass = arguments[0].customClass || p.customClass,
                        p.allowOutsideClick = arguments[0].allowOutsideClick || g.allowOutsideClick,
                        p.showCancelButton = void 0 !== arguments[0].showCancelButton ? arguments[0].showCancelButton : g.showCancelButton,
                        p.closeOnConfirm = void 0 !== arguments[0].closeOnConfirm ? arguments[0].closeOnConfirm : g.closeOnConfirm,
                        p.closeOnCancel = void 0 !== arguments[0].closeOnCancel ? arguments[0].closeOnCancel : g.closeOnCancel,
                        p.timer = arguments[0].timer || g.timer,
                        p.confirmButtonText = g.showCancelButton ? "Confirm" : g.confirmButtonText,
                        p.confirmButtonText = arguments[0].confirmButtonText || g.confirmButtonText,
                        p.confirmButtonColor = arguments[0].confirmButtonColor || g.confirmButtonColor,
                        p.cancelButtonText = arguments[0].cancelButtonText || g.cancelButtonText,
                        p.imageUrl = arguments[0].imageUrl || g.imageUrl,
                        p.imageSize = arguments[0].imageSize || g.imageSize,
                        p.doneFunction = arguments[1] || null;
                    break;
                default:
            ...
            }, v = m.querySelectorAll("button"), x = 0; x < v.length; x++)
                v[x].onclick = y,
                    v[x].onmouseover = y,
                    v[x].onmouseout = y,
                    v[x].onmousedown = y,
        ...
        function i(t) {
            ...
            if (i.innerHTML = P(t.title).split("\n").join("<br>"),
                r.innerHTML = P(t.text || "").split("\n").join("<br>"),
            t.text && S(r),
            t.customClass && w(n, t.customClass),
                j(n.querySelectorAll(".icon")),
                t.type) {
                ...
                switch (S(u),
                    ...
                    case "success":
                        w(u, "animate"),
                            w(u.querySelector(".tip"), "animateSuccessTip"),
                            w(u.querySelector(".long"), "animateSuccessLong");
                        break;
                    case "error":
                        w(u, "animateErrorIcon"),
                            w(u.querySelector(".x-mark"), "animateXMark");
                        break;
                    case "warning":
                        w(u, "pulseWarning"),
                            w(u.querySelector(".body"), "pulseWarningIns"),
                            w(u.querySelector(".dot"), "pulseWarningIns")
                }
            }
            if (t.imageUrl) {
            ...
            n.setAttribute("data-has-cancel-button", t.showCancelButton),
                t.showCancelButton ? o.style.display = "inline-block" : j(o),
            t.cancelButtonText && (o.innerHTML = P(t.cancelButtonText)),
            t.confirmButtonText && (a.innerHTML = P(t.confirmButtonText)),
                a.style.backgroundColor = t.confirmButtonColor,
                s(a, t.confirmButtonColor),
        ...
        function c() {
            ...
            T(i, "animate"),
                T(i.querySelector(".tip"), "animateSuccessTip"),
                T(i.querySelector(".long"), "animateSuccessLong");
            var r = n.querySelector(".icon.error");
            T(r, "animateErrorIcon"),
                T(r.querySelector(".x-mark"), "animateXMark");
            var o = n.querySelector(".icon.warning");
            T(o, "pulseWarning"),
                T(o.querySelector(".body"), "pulseWarningIns"),
                T(o.querySelector(".dot"), "pulseWarningIns"),
                e.onkeydown = f,
                t.onclick = d,
            p && p.focus(),
                h = void 0,
        ...
        var p, d, f, h, m = ".sweet-alert", y = ".sweet-overlay", v = ["error", "warning", "info", "success"], g = {
            title: "",
            text: "",
            type: null,
            allowOutsideClick: !1,
        ...
        e.sweetAlertInitialize = function() {
            ...
            function() {
                "complete" === t.readyState || "interactive" === t.readyState && t.body ? e.sweetAlertInitialize() : t.addEventListener ? t.addEventListener("DOMContentLoaded", function n() {
                    ...
                    "complete" === t.readyState && (t.detachEvent("onreadystatechange", i),
                        e.sweetAlertInitialize())
                })
            }()
    }(window, document),
    function(e) {
        ...
        var o = 0
            , a = function() {
            var t, n = i.userAgent, r = /msie\s\d+/i;
            return n.search(r) > 0 && (t = r.exec(n).toString(),
                t = t.split(" ")[1],
            t < 9) && (e("html").addClass("lt-ie9"),
                !0)
        }();
        Function.prototype.bind || (Function.prototype.bind = function(e) {
                var t = this
        ...
        var s = '<span class="irs"><span class="irs-line" tabindex="0"><span class="irs-line-left"></span><span class="irs-line-mid"></span><span class="irs-line-right"></span></span><span class="irs-min">0</span><span class="irs-max">1</span><span class="irs-from">0</span><span class="irs-to">0</span><span class="irs-single">0</span></span><span class="irs-grid"></span><span class="irs-bar"></span>'
            ...
            var s, l, c, u = this.$cache.input, p = u.prop("value");
            s = {
                type: "single",
                min: 10,
                max: 100,
            ...
            "INPUT" !== u[0].nodeName && console && console.warn && console.warn("Base element should be <input>!", u[0]),
                l = {
                    type: u.data("type"),
                    min: u.data("min"),
                    max: u.data("max"),
            ...
            for (c in l)
                l.hasOwnProperty(c) && (l[c] !== r && "" !== l[c] || delete l[c]);
            p !== r && "" !== p && (p = p.split(l.input_values_separator || o.input_values_separator || ";"),
            p[0] && p[0] == +p[0] && (p[0] = +p[0]),
            p[1] && p[1] == +p[1] && (p[1] = +p[1]),
                o && o.values && o.values.length ? (s.from = p[0] && o.values.indexOf(p[0]),
                    s.to = p[1] && o.values.indexOf(p[1])) : (s.from = p[0] && +p[0],
                    s.to = p[1] && +p[1])),
                e.extend(s, o),
                e.extend(s, l),
                this.options = s,
        ...
        p.prototype = {
            ...
            append: function() {
                ...
                this.$cache.input.before(e),
                    ...
                    "single" === this.options.type ? (this.$cache.cont.append(l),
                        this.$cache.edge = this.$cache.cont.find(".irs-bar-edge"),
                        this.$cache.s_single = this.$cache.cont.find(".single"),
                        this.$cache.from[0].style.visibility = "hidden",
                        this.$cache.to[0].style.visibility = "hidden",
                        this.$cache.shad_single = this.$cache.cont.find(".shadow-single")) : (this.$cache.cont.append(c),
            ...
            remove: function() {
                ...
                a && (this.$cache.body.off("mouseup.irs_" + this.plugin_count),
            ...
            bindEvents: function() {
                ...
                a && (this.$cache.body.on("mouseup.irs_" + this.plugin_count, this.pointerUp.bind(this)),
                    this.$cache.body.on("mouseleave.irs_" + this.plugin_count, this.pointerUp.bind(this))))
            },
            pointerFocus: function(e) {
                if (!this.target) {
                    var t, n;
                    n = "single" === this.options.type ? this.$cache.single : this.$cache.from,
                        t = n.offset().left,
                        t += n.width() / 2 - 1,
            ...
            pointerDown: function(t, n) {
                ...
                2 !== n.button && ("both" === t && this.setTempMinInterval(),
            ...
            pointerClick: function(e, t) {
                ...
                2 !== t.button && (this.current_plugin = this.plugin_count,
                    this.target = e,
                    this.is_click = !0,
                    this.coords.x_gap = this.$cache.rs.offset().left,
            ...
            calc: function(e) {
                ...
                (10 === this.calc_count || e) && (this.calc_count = 0,
                    ...
                    "click" === this.target && (this.coords.p_gap = this.coords.p_handle / 2,
                        t = this.getHandleX(),
                        this.options.drag_interval ? this.target = "both_one" : this.target = this.chooseHandle(t)),
                        this.target) {
                        case "base":
                            var n = (this.options.max - this.options.min) / 100
                                , i = (this.result.from - this.options.min) / n
                                , r = (this.result.to - this.options.min) / n;
                            this.coords.p_single_real = this.toFixed(i),
                                this.coords.p_from_real = this.toFixed(i),
                        ...
                        case "both_one":
                            ...
                            p > 100 && (p = 100,
                                u = p - l),
                                this.coords.p_from_real = this.calcWithStep(u),
                                this.coords.p_from_real = this.checkDiapason(this.coords.p_from_real, this.options.from_min, this.options.from_max),
                                this.coords.p_from_fake = this.convertToFakePercent(this.coords.p_from_real),
                                this.coords.p_to_real = this.calcWithStep(p),
                                this.coords.p_to_real = this.checkDiapason(this.coords.p_to_real, this.options.to_min, this.options.to_max),
                                this.coords.p_to_fake = this.convertToFakePercent(this.coords.p_to_real)
                    }
            ...
            drawLabels: function() {
                if (this.options) {
                    var e, t, n, i, r, o = this.options.values.length, a = this.options.p_values;
                    if (!this.options.hide_from_to)
                        if ("single" === this.options.type)
                            o ? (e = this.decorate(a[this.result.from]),
                                this.$cache.single.html(e)) : (i = this._prettify(this.result.from),
                            ...
                            o ? (this.options.decorate_both ? (e = this.decorate(a[this.result.from]),
                                e += this.options.values_separator,
                                e += this.decorate(a[this.result.to])) : e = this.decorate(a[this.result.from] + this.options.values_separator + a[this.result.to]),
                                t = this.decorate(a[this.result.from]),
                                n = this.decorate(a[this.result.to]),
                                this.$cache.single.html(e),
                                this.$cache.from.html(t),
                                this.$cache.to.html(n)) : (i = this._prettify(this.result.from),
                                r = this._prettify(this.result.to),
                                this.options.decorate_both ? (e = this.decorate(i, this.result.from),
                                    e += this.options.values_separator,
                                    e += this.decorate(r, this.result.to)) : e = this.decorate(i + this.options.values_separator + r, this.result.to),
                                t = this.decorate(i, this.result.from),
                                n = this.decorate(r, this.result.to),
                                this.$cache.single.html(e),
                                this.$cache.from.html(t),
                            ...
                            this.labels.p_from_left + this.labels.p_from_fake >= this.labels.p_to_left ? (this.$cache.from[0].style.visibility = "hidden",
                                ...
                                this.result.from === this.result.to ? ("from" === this.target ? this.$cache.from[0].style.visibility = "visible" : "to" === this.target ? this.$cache.to[0].style.visibility = "visible" : this.target || (this.$cache.from[0].style.visibility = "visible"),
                                    ...
                                    u = c) : (this.$cache.from[0].style.visibility = "hidden",
                                    this.$cache.to[0].style.visibility = "hidden",
                                    this.$cache.single[0].style.visibility = "visible",
                                    u = Math.max(l, c))) : (this.$cache.from[0].style.visibility = "visible",
                                this.$cache.to[0].style.visibility = "visible",
                                this.$cache.single[0].style.visibility = "hidden"),
                                s < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible",
                                u > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible"
                        }
                }
            },
            drawShadow: function() {
                var e, t, n, i, r = this.options, o = this.$cache, a = "number" == typeof r.from_min && !isNaN(r.from_min), s = "number" == typeof r.from_max && !isNaN(r.from_max), l = "number" == typeof r.to_min && !isNaN(r.to_min), c = "number" == typeof r.to_max && !isNaN(r.to_max);
                "single" === r.type ? r.from_shadow && (a || s) ? (e = this.convertToPercent(a ? r.from_min : r.min),
                    t = this.convertToPercent(s ? r.from_max : r.max) - e,
                    e = this.toFixed(e - this.coords.p_handle / 100 * e),
                    t = this.toFixed(t - this.coords.p_handle / 100 * t),
                    e += this.coords.p_handle / 2,
                    o.shad_single[0].style.display = "block",
                    o.shad_single[0].style.left = e + "%",
                    o.shad_single[0].style.width = t + "%") : o.shad_single[0].style.display = "none" : (r.from_shadow && (a || s) ? (e = this.convertToPercent(a ? r.from_min : r.min),
                    t = this.convertToPercent(s ? r.from_max : r.max) - e,
                    e = this.toFixed(e - this.coords.p_handle / 100 * e),
                    t = this.toFixed(t - this.coords.p_handle / 100 * t),
                    e += this.coords.p_handle / 2,
                    o.shad_from[0].style.display = "block",
                    o.shad_from[0].style.left = e + "%",
                    o.shad_from[0].style.width = t + "%") : o.shad_from[0].style.display = "none",
                    r.to_shadow && (l || c) ? (n = this.convertToPercent(l ? r.to_min : r.min),
                        i = this.convertToPercent(c ? r.to_max : r.max) - n,
                        n = this.toFixed(n - this.coords.p_handle / 100 * n),
                        i = this.toFixed(i - this.coords.p_handle / 100 * i),
                        n += this.coords.p_handle / 2,
                        o.shad_to[0].style.display = "block",
                        o.shad_to[0].style.left = n + "%",
            ...
            convertToPercent: function(e, t) {
                ...
                return r ? (n = t ? e : e - this.options.min,
                    i = n / o,
                    this.toFixed(i)) : (this.no_diapason = !0,
                    0)
            },
            convertToValue: function(e) {
                var t, n, i = this.options.min, r = this.options.max, o = i.toString().split(".")[1], a = r.toString().split(".")[1], s = 0, l = 0;
                if (0 === e)
                ...
                i < 0 && (l = Math.abs(i),
                    i = +(i + l).toFixed(s),
                    r = +(r + l).toFixed(s));
                var c, u = (r - i) / 100 * e + i, p = this.options.step.toString().split(".")[1];
                return p ? u = +u.toFixed(p.length) : (u /= this.options.step,
                    u *= this.options.step,
                    u = +u.toFixed(0)),
                l && (u -= l),
                    c = p ? +u.toFixed(p.length) : this.toFixed(u),
                    c < this.options.min ? c = this.options.min : c > this.options.max && (c = this.options.max),
                    c
            },
            ...
            checkDiapason: function(e, t, n) {
                var i = this.convertToValue(e)
                    , r = this.options;
                return "number" != typeof t && (t = r.min),
                "number" != typeof n && (n = r.max),
                i < t && (i = t),
                i > n && (i = n),
                    this.convertToPercent(i)
            },
            toFixed: function(e) {
            ...
            checkEdges: function(e, t) {
                return this.options.force_edges ? (e < 0 ? e = 0 : e > 100 - t && (e = 100 - t),
                    this.toFixed(e)) : this.toFixed(e)
            },
            validate: function() {
                var e, t, n = this.options, i = this.result, r = n.values, o = r.length;
                if ("string" == typeof n.min && (n.min = +n.min),
                ...
                ("number" != typeof n.to || isNaN(n.to)) && (n.to = n.max),
                    "single" === n.type ? (n.from < n.min && (n.from = n.min),
                    n.from > n.max && (n.from = n.max)) : (n.from < n.min && (n.from = n.min),
                    n.from > n.max && (n.from = n.max),
                    n.to < n.min && (n.to = n.min),
                    n.to > n.max && (n.to = n.max),
                    this.update_check.from && (this.update_check.from !== n.from && n.from > n.to && (n.from = n.to),
                ...
                i && (i.min !== n.min && (i.min = n.min),
                i.max !== n.max && (i.max = n.max),
                (i.from < i.min || i.from > i.max) && (i.from = n.from),
                (i.to < i.min || i.to > i.max) && (i.to = n.to)),
                ("number" != typeof n.min_interval || isNaN(n.min_interval) || !n.min_interval || n.min_interval < 0) && (n.min_interval = 0),
            ...
            decorate: function(e, t) {
                var n = ""
                    , i = this.options;
                return i.prefix && (n += i.prefix),
                    n += e,
                i.max_postfix && (i.values.length && e === i.p_values[i.max] ? (n += i.max_postfix,
                i.postfix && (n += " ")) : t === i.max && (n += i.max_postfix,
                i.postfix && (n += " "))),
            ...
            appendGrid: function() {
                if (this.options.grid) {
                    var e, t, n, i, r, o = this.options, a = o.max - o.min, s = o.grid_num, l = 0, c = 0, u = 4, p = 0, d = "";
                    for (this.calcGridMargin(),
                             o.grid_snap ? a > 50 ? (s = 50 / o.step,
                                 l = this.toFixed(o.step / .5)) : (s = a / o.step,
                                 l = this.toFixed(o.step / (a / 100))) : l = this.toFixed(100 / s),
                         s > 4 && (u = 3),
                         s > 7 && (u = 2),
                         s > 14 && (u = 1),
                         s > 28 && (u = 0),
                        ...
                        for (n = u,
                             ...
                             c > 100 && (c = 100),
                                 ...
                                 i = (c - l * (e - 1)) / (n + 1),
                                 t = 1; t <= n && 0 !== c; t++)
                            p = this.toFixed(c - i * t),
                                d += '<span class="irs-grid-pol small" style="left: ' + p + '%"></span>';
                        d += '<span class="irs-grid-pol" style="left: ' + c + '%"></span>',
                            r = this.convertToValue(c),
                            r = o.values.length ? o.p_values[r] : this._prettify(r),
                            d += '<span class="irs-grid-text js-grid-text-' + e + '" style="left: ' + c + '%">' + r + "</span>"
                    }
            ...
            cacheGridLabels: function() {
                ...
                for (t = 0; t < n; t++)
                    e = this.$cache.grid.find(".js-grid-text-" + t),
                        this.$cache.grid_labels.push(e);
                this.calcGridLabels()
            },
            calcGridLabels: function() {
                var e, t, n = [], i = [], r = this.coords.big_num;
                for (e = 0; e < r; e++)
                    this.coords.big_w[e] = this.$cache.grid_labels[e].outerWidth(!1),
                        ...
                        i[e] = this.toFixed(n[e] + this.coords.big_p[e]);
                for (this.options.force_edges && (n[0] < -this.coords.grid_gap && (n[0] = -this.coords.grid_gap,
                    i[0] = this.toFixed(n[0] + this.coords.big_p[0]),
                    this.coords.big_x[0] = this.coords.grid_gap),
                i[r - 1] > 100 + this.coords.grid_gap && (i[r - 1] = 100 + this.coords.grid_gap,
                    n[r - 1] = this.toFixed(i[r - 1] - this.coords.big_p[r - 1]),
                    this.coords.big_x[r - 1] = this.toFixed(this.coords.big_p[r - 1] - this.coords.grid_gap))),
                         this.calcGridCollision(2, n, i),
                         this.calcGridCollision(4, n, i),
                         e = 0; e < r; e++)
                    t = this.$cache.grid_labels[e][0],
                    this.coords.big_x[e] !== Number.POSITIVE_INFINITY && (t.style.marginLeft = -this.coords.big_x[e] + "%")
            },
            calcGridCollision: function(e, t, n) {
                ...
                for (i = 0; i < a && (r = i + e / 2,
                    ...
                    o = this.$cache.grid_labels[r][0],
                        n[i] <= t[r] ? o.style.visibility = "visible" : o.style.visibility = "hidden"
            },
    ...
    function(e) {
        ...
        function t(e, t) {
            if (e.classList)
                ...
                for (var n = [], i = e.className.split(" "), r = 0; r < i.length; r++)
                    i[r] !== t && n.push(i[r]);
                e.className = n.join(" ")
            }
        }
        function n(e, t) {
            this.options = t || {},
                ...
                this.DOM.el = e,
                this.DOM.stackItems = [],
                this.DOM.img = e.querySelector("img,svg"),
                this.DOM.stack = e.parentElement;
            for (var n = 0; n < 4; n++) {
                var i = document.createElement("div");
                if (i.className = "stack__deco",
                    this.options.style)
                    for (var r in this.options.style)
                        i.style[r] = this.options.style[r];
                this.DOM.stack.insertBefore(i, e),
                    this.DOM.stackItems.push(i)
            }
            this.DOM.stackItems.push(e),
        ...
        e.stackEffects = {},
            e.stackEffects.getInstance = function(e, t, i) {
                var r = {
                    AlphardFx: {
                        duration: 1200,
                        steps: []
                ...
                return i.steps = a.steps,
                    o.animeDuration = a.duration,
                    o
            }
            ,
            n.prototype.destroy = function() {
                for (var e = 0; e < this.DOM.stackItems.length; e++)
                    this.DOM.stackItems[e] !== this.DOM.el && this.DOM.stackItems[e].remove();
                t(this.DOM.stack, "hover-stack"),
                    t(this.DOM.stack, "hover-stack-run-animate"),
                    t(this.DOM.stack, "hover-stack-enable-scale"),
                this.options && this.options.effectType && t(this.DOM.stack, this.options.effectType),
                    t(this.DOM.el, "hover-stack-image-container"),
                this._mouseleaveFn && this._mouseenterFn && (this._mouseleaveFn(),
    ...
    function(e, t, n) {
        ...
        function s(n) {
            function i() {
                var e = h.cloneNode();
                return "solid" != g.type && (e[p ? "src" : "innerHTML"] = "string" == typeof g.content ? g.content : g.content[0 == f ? 0 : Math.floor(Math.random() * f)]),
                    e
            }
            function s() {
                var e, t = r(g.minSize, g.maxSize), n = -2 * t, o = r(0, x - t), s = r(5, 10) / 10, l = r(null, .8 * _, 1), c = r(-100, 100), u = _ + 2 * t, p = r(null, 20 * _, .2);
                v.length ? (e = v.shift(),
                e.dataset.type != g.type && (e = new i)) : e = new i;
                var d = {
                    top: n + "px",
                    left: o + "px",
                    opacity: s,
            ...
            var p, f, h, m, y = this, v = [], g = u, b = t.createElement("div");
            y.config = function(e) {
                o(g, e),
                    p = "image" == g.type,
                    f = g.content.length,
                    h = p ? new Image : t.createElement("div"),
            ...
            return e.addEventListener("resize", function() {
                x = g.root.scrollWidth,
                    _ = g.root.scrollHeight
            }, !1),
                y.playing = 0,
                y.play = function() {
                    y.playing || (m = setInterval(s, g.interval),
                        y.playing = 1)
                }
                ,
                y.stop = function() {
                ...
                b.addEventListener(d, function(e) {
        ...
        "undefined" != typeof t.hidden ? (l = "hidden",
            c = "visibilitychange") : "undefined" != typeof t.mozHidden ? (l = "mozHidden",
            c = "mozvisibilitychange") : "undefined" != typeof t.msHidden ? (l = "msHidden",
            c = "msvisibilitychange") : "undefined" != typeof t.webkitHidden && (l = "webkitHidden",
        ...
        e.fn.pagepiling = function(r) {
            ...
            function s(t, n) {
                ...
                if (!i.activeSection.is(t)) {
                    "undefined" == typeof i.animated && (i.animated = !0),
                    "undefined" != typeof i.anchorLink && f(i.anchorLink, i.sectionIndex),
                        i.destination.addClass("active").siblings().removeClass("active"),
                        i.sectionsToMove = u(i),
                        "down" === i.yMovement ? (i.translate3d = L(),
                            i.scrolling = "-100%",
                        U.css3 || i.sectionsToMove.each(function(t) {
                            ...
                            i.scrolling = "0",
                            i.animateSection = t),
                    e.isFunction(U.onLeave) && U.onLeave.call(this, i.leavingSection, i.sectionIndex + 1, i.yMovement),
                        l(i),
                        Q(i.anchorLink),
                        I(i.anchorLink, i.sectionIndex),
                        O = i.anchorLink;
                    var r = (new Date).getTime();
                    z = r
                }
            ...
            function l(t) {
                U.css3 ? (b(t.animateSection, t.translate3d, t.animated),
                    t.sectionsToMove.each(function() {
                        b(e(this), t.translate3d, t.animated)
                    }),
                    setTimeout(function() {
                        c(t)
                    }, U.scrollingSpeed)) : (t.scrollOptions = d(t.scrolling),
                    t.animated ? t.animateSection.animate(t.scrollOptions, U.scrollingSpeed, U.easing, function() {
                        p(t),
                            c(t)
                    }) : (t.animateSection.css(d(t.scrolling)),
                        setTimeout(function() {
                            p(t),
                                c(t)
                        }, 400)))
            ...
            function v() {
                ...
                if (r.length && r && r !== O) {
                    var o;
                    o = isNaN(r) ? e(t).find('[data-anchor="' + r + '"]') : e(".pp-section").eq(r - 1),
                        s(o)
                }
            }
            function g(e) {
            ...
            function P() {
                B.get(0).addEventListener ? (B.get(0).removeEventListener("mousewheel", x, !1),
                    B.get(0).removeEventListener("wheel", x, !1)) : B.get(0).detachEvent("onmousewheel", x)
            }
            function k() {
                B.get(0).addEventListener ? (B.get(0).addEventListener("mousewheel", x, !1),
                    B.get(0).addEventListener("wheel", x, !1)) : B.get(0).attachEvent("onmousewheel", x)
            }
            function S() {
                if (R) {
                    var e = j();
                    B.off("touchstart " + e.down).on("touchstart " + e.down, E),
                        B.off("touchmove " + e.move).on("touchmove " + e.move, A)
                }
            }
            function C() {
                if (R) {
            ...
            function A(t) {
                ...
                if (!M(t.target) && Y(n)) {
                    var i = e(".pp-section.active")
                        , r = T(i);
                    if (r.length || t.preventDefault(),
                        !y()) {
                        var o = $(n);
                        W = o.y,
                            V = o.x,
                            "horizontal" === U.direction && Math.abs(q - V) > Math.abs(H - W) ? Math.abs(q - V) > B.width() / 100 * U.touchSensitivity && (q > V ? _("down", r) : V > q && _("up", r)) : Math.abs(H - W) > B.height() / 100 * U.touchSensitivity && (H > W ? _("down", r) : W > H && _("up", r))
                    }
                }
            }
            function M(t, n) {
            ...
            function D() {
                ...
                var t = e("#pp-nav");
                t.css("color", U.navigation.textColor),
                    t.addClass(U.navigation.position);
                for (var n = 0; n < e(".pp-section").length; n++) {
                    var i = "";
                    if (U.anchors.length && (i = U.anchors[n]),
                    "undefined" !== U.navigation.tooltips) {
            ...
            function I(t, n) {
                U.navigation && (e("#pp-nav").find(".active").removeClass("active"),
                    t ? e("#pp-nav").find('a[href="#' + t + '"]').addClass("active") : e("#pp-nav").find("li").eq(n).find("a").addClass("active"))
            }
            function Q(t) {
                U.menu && (e(U.menu).find(".active").removeClass("active"),
                    e(U.menu).find('[data-menuanchor="' + t + '"]').addClass("active"))
            }
            function F() {
                var e, r = t.createElement("p"), o = {
                ...
                for (var a in o)
                    r.style[a] !== i && (r.style[a] = "translate3d(1px,1px,1px)",
                        e = n.getComputedStyle(r).getPropertyValue(o[a]));
            ...
            var O, N = e.fn.pagepiling, B = e(this), z = 0, R = "ontouchstart"in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, H = 0, q = 0, W = 0, V = 0, X = 600, U = e.extend(!0, {
                direction: "vertical",
                menu: null,
                verticalCentered: !0,
                sectionsColor: [],
            ...
            e.extend(e.easing, {
                ...
                N.setAllowScrolling = function(e) {
                    e ? (N.setMouseWheelScrolling(!0),
                        S()) : (N.setMouseWheelScrolling(!1),
                        C())
                }
                ,
                ...
                N.moveSectionUp = function() {
                    ...
                    !t.length && U.loopTop && (t = e(".pp-section").last()),
                    t.length && s(t)
                }
                ,
                N.moveSectionDown = function() {
                    var t = e(".pp-section.active").next(".pp-section");
                    !t.length && U.loopBottom && (t = e(".pp-section").first()),
                    t.length && s(t)
                }
                ,
                N.moveTo = function(n) {
                    var i = "";
                    i = isNaN(n) ? e(t).find('[data-anchor="' + n + '"]') : e(".pp-section").eq(n - 1),
                    i.length > 0 && s(i)
                }
                ,
            ...
            e.isEmptyObject(U.navigation) || D();
            ...
            e(".pp-section").each(function(t) {
                ...
                "undefined" != typeof U.anchors[t] && e(this).attr("data-anchor", U.anchors[t]),
                "undefined" != typeof U.sectionsColor[t] && e(this).css("background-color", U.sectionsColor[t]),
                U.verticalCentered && !e(this).hasClass("pp-scrollable") && o(e(this)),
                    G -= 1
            }).promise().done(function() {
                U.navigation && (e("#pp-nav").css("margin-top", "-" + e("#pp-nav").height() / 2 + "px"),
    ...
    function(e, t) {
        ...
        function i(e) {
            this.__target = e,
                this.__clientWidth = a(e),
                this.__clientHeight = s(e)
        }
        function r(e) {
            this.__target = e,
                this.__lastBroadcastWidth = a(e),
                this.__lastBroadcastHeight = s(e)
        }
        function o(e, t) {
        ...
        function l() {
            for (var e = 0; e < document.resizeObservers.length; e += 1)
                document.resizeObservers[e].__populateActiveTargets()
        }
        function c() {
                ...
                if (0 !== t.__activeTargets.length) {
                    for (var n = [], r = 0; r < t.__activeTargets.length; r += 1) {
                        var o = t.__activeTargets[r]
                            , l = new i(o.target());
                        n.push(l),
                            o.__lastBroadcastWidth = a(o.target()),
                            o.__lastBroadcastHeight = s(o.target())
                    }
                    t.__callback(n),
                        t.__activeTargets = []
                }
        ...
        "undefined" == typeof e.ResizeObserver && (document.resizeObservers = [],
            e.ResizeObserver = n,
    ...
    function(e) {
        ...
        var o = function(o, c) {
            ...
            c && t(p, c),
                ...
                p.fn.retinaInit = function() {
                    p.retina_detect && e.devicePixelRatio > 1 ? (p.canvas.pxratio = e.devicePixelRatio,
                        p.tmp.retina = !0) : (p.canvas.pxratio = 1,
                        p.tmp.retina = !1),
                        p.canvas.w = p.canvas.w * p.canvas.pxratio,
                        p.canvas.h = p.canvas.h * p.canvas.pxratio,
                ...
                p.fn.resize = function(e) {
                    ...
                    p.fn.resize.timeoutID = setTimeout(function() {
                        ...
                        p.particles.move.enable || (p.fn.particlesEmpty(),
                            ...
                            p.fn.vendors.densityAutoParticles(),
                            delete p.fn.resize.timeoutID
                    }, e || 200)
                }
                ,
                p.fn.canvasSize = function() {
                    p.canvas.el.width = o.clientWidth,
                        p.canvas.el.height = o.clientHeight,
                    p && p.interactivity.events.resize && e.addEventListener("resize", function() {
                        p.fn.resize()
                    })
                }
                ,
                p.fn.canvasResize = function() {
                    ...
                    if (p && !p.interactivity.events.resizeElement)
                        return p.canvas.el.style.width = "100%",
                            void (p.canvas.el.style.height = "100%");
                    var t = o.clientWidth
                        , n = o.clientHeight
                        , i = new ResizeObserver(e);
                    i.observe(o),
                        p.canvas.observers.push(i)
                }
                ,
                ...
                p.fn.particle = function(e, t, i) {
                    ...
                    "object" == typeof e.value)
                        ...
                        "random" == e.value ? this.color.rgb = {
                            ...
                            this.color.rgb = n(this.color.value));
                    ...
                    p.particles.move.straight ? (this.vx = o.x,
                        this.vy = o.y,
                    ...
                    if ("image" == this.shape) {
                        ...
                        "svg" == p.tmp.img_type && void 0 != p.tmp.source_svg && (p.fn.vendors.createSvgImg(this),
                ...
                p.fn.particle.prototype.draw = function() {
                    ...
                    if (t.color.rgb)
                        ...
                        var r = "hsla(" + t.color.hsl.h + "," + t.color.hsl.s + "%," + t.color.hsl.l + "%," + i + ")";
                    switch (p.canvas.ctx.fillStyle = r,
                    ...
                    p.particles.shape.stroke.width > 0 && (p.canvas.ctx.strokeStyle = p.particles.shape.stroke.color,
                ...
                p.fn.particlesUpdate = function() {
                    for (var e = 0; e < p.particles.array.length; e++) {
                        ...
                        switch (t.x - t.radius > p.canvas.w ? (t.x = i.x_left,
                            ...
                            case "bounce":
                                t.x + t.radius > p.canvas.w ? t.vx = -t.vx : t.x - t.radius < 0 && (t.vx = -t.vx),
                                    t.y + t.radius > p.canvas.h ? t.vy = -t.vy : t.y - t.radius < 0 && (t.vy = -t.vy)
                        }
                        if (r("grab", p.interactivity.events.onhover.mode) && p.fn.modes.grabParticle(t),
                        (r("bubble", p.interactivity.events.onhover.mode) || r("bubble", p.interactivity.events.onclick.mode)) && p.fn.modes.bubbleParticle(t),
                        (r("repulse", p.interactivity.events.onhover.mode) || r("repulse", p.interactivity.events.onclick.mode)) && p.fn.modes.repulseParticle(t),
                        p.particles.line_linked.enable || p.particles.move.attract.enable)
                            for (var o = e + 1; o < p.particles.array.length; o++) {
                                ...
                                p.particles.line_linked.enable && p.fn.interact.linkParticles(t, a),
                                p.particles.move.attract.enable && p.fn.interact.attractParticles(t, a),
                                p.particles.move.bounce && p.fn.interact.bounceParticles(t, a)
                            }
                    }
                }
                ,
                ...
                p.fn.particlesRefresh = function() {
                    s(p.fn.checkAnimFrame),
                        s(p.fn.drawAnimFrame),
                ...
                p.fn.modes.bubbleParticle = function(e) {
                    ...
                    if (p.interactivity.events.onhover.enable && r("bubble", p.interactivity.events.onhover.mode)) {
                        ...
                        if (p.tmp.bubble_clicking) {
                            ...
                            d > p.interactivity.modes.bubble.duration && (p.tmp.bubble_duration_end = !0),
                            d > 2 * p.interactivity.modes.bubble.duration && (p.tmp.bubble_clicking = !1,
                                p.tmp.bubble_duration_end = !1)
                        }
                        p.tmp.bubble_clicking && (n(p.interactivity.modes.bubble.size, p.particles.size.value, e.radius_bubble, e.radius, "size"),
                            n(p.interactivity.modes.bubble.opacity, p.particles.opacity.value, e.opacity_bubble, e.opacity, "opacity"))
                    }
                }
                ,
                p.fn.modes.repulseParticle = function(e) {
                    function t() {
                        ...
                        "bounce" == p.particles.move.out_mode) {
                            ...
                            n.x + e.radius > p.canvas.w ? e.vx = -e.vx : n.x - e.radius < 0 && (e.vx = -e.vx),
                                n.y + e.radius > p.canvas.h ? e.vy = -e.vy : n.y - e.radius < 0 && (e.vy = -e.vy)
                        }
                    }
                    if (p.interactivity.events.onhover.enable && r("repulse", p.interactivity.events.onhover.mode) && "mousemove" == p.interactivity.status) {
                        ...
                        "bounce" == p.particles.move.out_mode ? (d.x - e.radius > 0 && d.x + e.radius < p.canvas.w && (e.x = d.x),
                        d.y - e.radius > 0 && d.y + e.radius < p.canvas.h && (e.y = d.y)) : (e.x = d.x,
                            e.y = d.y)
                        ...
                        p.tmp.repulse_count == p.particles.array.length && (p.tmp.repulse_finish = !0)),
                            ...
                            0 == p.tmp.repulse_clicking && (e.vx = e.vx_i,
                                e.vy = e.vy_i)
                }
                ,
                ...
                p.fn.vendors.eventsListeners = function() {
                    "window" == p.interactivity.detect_on ? p.interactivity.el = e : p.interactivity.el = p.canvas.el,
                    ...
                    (p.interactivity.events.onhover.enable || p.interactivity.events.onclick.enable) && (p.interactivity.el.addEventListener("mousemove", function(t) {
                        if (p.interactivity.el === e)
                            var n = getElementPosition(p.canvas.el)
                                , i = t.clientX - n.targetX
                                , r = t.clientY - n.targetY;
                        else
                            var i = t.offsetX || t.clientX
                                , r = t.offsetY || t.clientY;
                        p.interactivity.mouse.pos_x = i,
                            p.interactivity.mouse.pos_y = r,
                    ...
                    p.interactivity.events.onclick.enable && p.interactivity.el.addEventListener("click", function(e) {
                        ...
                        p.interactivity.events.onclick.enable && "mousemove" === p.interactivity.status) {
                            if (p.interactivity.events.onclick.handler instanceof Function && p.interactivity.events.onclick.handler.call(p, e) === !1)
                                return;
                ...
                p.fn.vendors.checkOverlap = function(e, t) {
                    for (var n = 0; n < p.particles.array.length; n++) {
                        var i = p.particles.array[n]
                            ...
                            , o = e.y - i.y
                            , a = Math.sqrt(r * r + o * o);
                        a <= e.radius + i.radius && (e.x = t ? t.x : Math.random() * p.canvas.w,
                ...
                p.fn.vendors.createSvgImg = function(t) {
                    var n = p.tmp.source_svg
                        ...
                        if (t.color.rgb)
                            ...
                            var o = "hsla(" + t.color.hsl.h + "," + t.color.hsl.s + "%," + t.color.hsl.l + "%," + t.opacity + ")";
                        return o
                    })
                        , o = new Blob([r],{
                ...
                p.fn.vendors.destroypJS = function() {
                    ...
                    for (var e = 0; e < p.canvas.observers.length; e++)
                        p.canvas.observers[e].disconnect();
                    u.remove()
                }
                ,
                ...
                p.fn.vendors.draw = function() {
                    "image" == p.particles.shape.type ? "svg" == p.tmp.img_type ? p.tmp.count_svg >= p.particles.number.value ? (p.fn.particlesDraw(),
                        p.particles.move.enable ? p.fn.drawAnimFrame = a(p.fn.vendors.draw) : s(p.fn.drawAnimFrame)) : p.tmp.img_error || (p.fn.drawAnimFrame = a(p.fn.vendors.draw)) : void 0 != p.tmp.img_obj ? (p.fn.particlesDraw(),
                        p.particles.move.enable ? p.fn.drawAnimFrame = a(p.fn.vendors.draw) : s(p.fn.drawAnimFrame)) : p.tmp.img_error || (p.fn.drawAnimFrame = a(p.fn.vendors.draw)) : (p.fn.particlesDraw(),
                        p.particles.move.enable ? p.fn.drawAnimFrame = a(p.fn.vendors.draw) : s(p.fn.drawAnimFrame))
                }
                ,
                p.fn.vendors.checkBeforeDraw = function() {
                    "image" == p.particles.shape.type ? "svg" == p.tmp.img_type && void 0 == p.tmp.source_svg ? p.tmp.checkAnimFrame = a(check) : (s(p.tmp.checkAnimFrame),
                ...
                p.fn.vendors.init = function() {
                    p.particles.line_linked.color_rgb_line = n(p.particles.line_linked.color),
                        p.fn.retinaInit(),
                        p.fn.canvasInit(),
                        p.fn.canvasSize(),
                        p.fn.canvasResize(),
                ...
                p.fn.vendors.start = function() {
                    r("image", p.particles.shape.type) ? (p.tmp.img_type = p.particles.shape.image.src.substr(p.particles.shape.image.src.length - 3),
        ...
        e.particlesJS = function(e, t) {
            ...
            if ("string" == typeof e)
                ...
                if ("object" != typeof e)
                    return void console.error("Element for particle not found");
                n = e
            }
...
!function(jQuery, ytp) {
        ...
        jQuery.fn.CSSAnimate = function(e, t, n, i, r) {
            ...
            return jQuery.support.CSStransition = function() {
                ...
                this.each(function() {
                    ...
                    if (s.CSSAIsRunning && s.eventType == c.type)
                        s.CSSqueue = function() {
                            l.CSSAnimate(e, t, n, i, r)
                        }
                        ;
                    else if (s.CSSqueue = null,
                        s.eventType = c.type,
                    0 !== l.length && e) {
                        if (s.CSSAIsRunning = !0,
                        "function" == typeof t && (r = t,
                            t = jQuery.fx.speeds._default),
                        "function" == typeof n && (r = n,
                            n = 0),
                        "function" == typeof i && (r = i,
                            i = "cubic-bezier(0.65,0.03,0.36,0.72)"),
                        "string" == typeof t)
                        ...
                        if (t || (t = jQuery.fx.speeds._default),
                            ...
                            var p = ""
                                , d = "transitionEnd";
                            jQuery.browser.webkit ? (p = "-webkit-",
                                d = "webkitTransitionEnd") : jQuery.browser.mozilla ? (p = "-moz-",
                                d = "transitionend") : jQuery.browser.opera ? (p = "-o-",
                                d = "otransitionend") : jQuery.browser.msie && (p = "-ms-",
                                d = "msTransitionEnd"),
                                c = [];
                            for (f in e)
                                u = f,
                                "transform" === u && (u = p + "transform",
                                    e[u] = e[f],
                                    delete e[f]),
                                "filter" === u && (u = p + "filter",
                                    e[u] = e[f],
                                    delete e[f]),
                                "transform-origin" !== u && "origin" !== u || (u = p + "transform-origin",
                                    e[u] = e[f],
                                    delete e[f]),
                                "x" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " translateX(" + a(e[f], "px") + ")",
                                    delete e[f]),
                                "y" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " translateY(" + a(e[f], "px") + ")",
                                    delete e[f]),
                                "z" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " translateZ(" + a(e[f], "px") + ")",
                                    delete e[f]),
                                "rotate" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " rotate(" + a(e[f], "deg") + ")",
                                    delete e[f]),
                                "rotateX" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " rotateX(" + a(e[f], "deg") + ")",
                                    delete e[f]),
                                "rotateY" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " rotateY(" + a(e[f], "deg") + ")",
                                    delete e[f]),
                                "rotateZ" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " rotateZ(" + a(e[f], "deg") + ")",
                                    delete e[f]),
                                "scale" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " scale(" + a(e[f], "") + ")",
                                    delete e[f]),
                                "scaleX" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " scaleX(" + a(e[f], "") + ")",
                                    delete e[f]),
                                "scaleY" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " scaleY(" + a(e[f], "") + ")",
                                    delete e[f]),
                                "scaleZ" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " scaleZ(" + a(e[f], "") + ")",
                                    delete e[f]),
                                "skew" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " skew(" + a(e[f], "deg") + ")",
                                    delete e[f]),
                                "skewX" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " skewX(" + a(e[f], "deg") + ")",
                                    delete e[f]),
                                "skewY" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " skewY(" + a(e[f], "deg") + ")",
                                    delete e[f]),
                                "perspective" === u && (u = p + "transform",
                                    e[u] = e[u] || "",
                                    e[u] += " perspective(" + a(e[f], "px") + ")",
                                    delete e[f]),
                                0 > c.indexOf(u) && c.push(o(u));
                            var f = c.join(",")
                                , h = function() {
                                l.off(d + "." + s.id),
                                ...
                                "function" == typeof r && r(l),
                                    s.called = !0,
                                    s.CSSAIsRunning = !1,
                                "function" == typeof s.CSSqueue && (s.CSSqueue(),
                                    s.CSSqueue = null)
                            }
                                , m = {};
                            jQuery.extend(m, e),
                                m[p + "transition-property"] = f,
                                m[p + "transition-duration"] = t + "ms",
                                m[p + "transition-delay"] = n + "ms",
                                m[p + "transition-style"] = "preserve-3d",
                                m[p + "transition-timing-function"] = i,
                                setTimeout(function() {
                                    l.one(d + "." + s.id, h),
                                        l.css(m)
                                }, 1),
                                s.timeout = setTimeout(function() {
                                    l.called || !r ? (l.called = !1,
                                        s.CSSAIsRunning = !1) : (l.css(p + "transition", ""),
                                        r(l),
                                        s.CSSAIsRunning = !1,
                                    "function" == typeof s.CSSqueue && (s.CSSqueue(),
                                        s.CSSqueue = null))
                            ...
                            for (var f in e)
                                "transform" === f && delete e[f],
                                "filter" === f && delete e[f],
                                "transform-origin" === f && delete e[f],
                                "auto" === e[f] && delete e[f];
            ...
            e.simpleSlider = {
                ...
                init: function(t) {
                    return this.each(function() {
                        ...
                        "auto" == n.opt.scale && (n.opt.scale = e(n).outerWidth()),
                            i.updateSliderVal(),
                        n.opt.readonly || (i.on("mousedown", function(e) {
                            n.canSlide = !0,
                                i.updateSliderVal(e)
                        }),
                ...
                updateSliderVal: function(t) {
                    ...
                    var o = e(r).outerWidth()
                        , a = e(r).outerHeight();
                    r.x = "object" == typeof t ? t.clientX + document.body.scrollLeft - i.offset().left : "number" == typeof t ? t * o / r.opt.scale : r.opt.initialval * o / r.opt.scale,
                        r.y = "object" == typeof t ? t.clientY + document.body.scrollTop - i.offset().top : "number" == typeof t ? (r.opt.scale - r.opt.initialval - t) * a / r.opt.scale : r.opt.initialval * a / r.opt.scale,
                        r.y = i.outerHeight() - r.y,
                        r.scaleX = r.x * r.opt.scale / o,
                        ...
                        r.value = "undefined" != typeof t ? "h" == r.opt.orientation ? r.x >= i.outerWidth() ? r.opt.scale : r.x <= 0 ? 0 : r.scaleX : r.y >= i.outerHeight() ? r.opt.scale : r.y <= 0 ? 0 : r.scaleY : "h" == r.opt.orientation ? r.scaleX : r.scaleY,
                        "h" == r.opt.orientation ? r.level.width(n(r.x, o) + "%") : r.level.height(n(r.y, a)),
    ...
    jQuery.mbYTPlayer = {
        ...
        getDataFromAPI: function(e) {
            if (e.videoData = jQuery.mbStorage.get("YYTPlayer_data_" + e.videoID),
                ...
                jQuery.getJSON("https://www.googleapis.com/youtube/v3/videos?id=" + e.videoID + "&key=" + e.opt.apiKey + "&part=snippet", function(t) {
                    ...
                    i.prop = {};
                    for (var r in e.videoData)
                        i.prop[r] = e.videoData[r];
                    jQuery(e).trigger(i)
                });
            else {
                if (e.hasData = !1,
        ...
        playlist: function(e, t, n) {
            ...
            r.videoID || (r.videos = e,
                r.videoCounter = 0,
                r.videoLength = e.length,
                jQuery(r).data("property", e[0]),
                jQuery(r).mb_YTPlayer()),
            "function" == typeof n && jQuery(r).on("YTPChanged", function() {
                n(r)
            }),
        ...
        fullscreen: function(real) {
            ...
            function RunPrefixMethod(e, t) {
                for (var n, i, r = ["webkit", "moz", "ms", "o", ""], o = 0; o < r.length && !e[n]; ) {
                    if (n = t,
                    "" == r[o] && (n = n.substr(0, 1).toLowerCase() + n.substr(1)),
                        n = r[o] + n,
                        i = typeof e[n],
                    "undefined" != i)
                        return r = [r[o]],
        ...
        mute: function() {
            ...
            if (!e.isMute) {
                ...
                i.time = e.player.time,
                e.canTrigger && jQuery(e).trigger(i)
            }
        },
        unmute: function() {
            var e = this.get(0);
        ...
        enableFilters: function() {
            ...
            for (var i in e.filters)
                e.filters[i].value && (n += i.replace("_", "-") + "(" + e.filters[i].value + e.filters[i].unit + ") ");
    ...
    !function(e, t) {
        ...
        function t(e) {
            ...
            for (o = e.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ",").split(","),
                     s = 0,
                     a = o.length; s < a && (n = o[s],
            n.search(/^(http|https|ftp):\/\//) === -1 && n.search(":") !== -1); s++)
                t = n.indexOf(":"),
                    i = n.substring(0, t),
                    r = n.substring(t + 1),
                r || (r = void 0),
        ...
        function n(e) {
            e = "" + e;
            var t, n, i, r = e.split(/\s+/), o = "50%", a = "50%";
            for (i = 0,
                     t = r.length; i < t; i++)
                n = r[i],
                    "left" === n ? o = "0%" : "right" === n ? o = "100%" : "top" === n ? a = "0%" : "bottom" === n ? a = "100%" : "center" === n ? 0 === i ? o = "50%" : a = "50%" : 0 === i ? o = n : a = n;
            return {
                x: o,
                y: a
            }
        ...
        function r(n, i, r) {
            ...
            "string" == typeof i)
                ...
                for (var o in i)
                    i.hasOwnProperty(o) && (i[o] = i[o].replace(/\.\w*$/, ""));
            this.settings = e.extend({}, a, r),
                this.path = i,
                this.init()
        }
        var o = "vide"
        ...
        r.prototype.init = function() {
            var t, r = this, o = n(r.settings.position), a = "";
            r.$wrapper = e("<div>").css({
                position: "absolute",
                "z-index": -1,
                top: 0,
                ...
                t = r.path,
            "object" == typeof r.path && (r.path.poster ? t = r.path.poster : r.path.mp4 ? t = r.path.mp4 : r.path.webm ? t = r.path.webm : r.path.ogv && (t = r.path.ogv)),
                "detect" === r.settings.posterType ? i(t, function(e) {
                    r.$wrapper.css("background-image", "url(" + e + ")")
                }) : "none" !== r.settings.posterType && r.$wrapper.css("background-image", "url(" + t + "." + r.settings.posterType + ")"),
            "static" === r.$element.css("position") && r.$element.css("position", "relative"),
                r.$element.prepend(r.$wrapper),
                "object" == typeof r.path ? (r.path.mp4 && (a += '<source src="' + r.path.mp4 + '.mp4" type="video/mp4">'),
                r.path.webm && (a += '<source src="' + r.path.webm + '.webm" type="video/webm">'),
                r.path.ogv && (a += '<source src="' + r.path.ogv + '.ogv" type="video/ogv">'),
                    r.$video = e("<video>" + a + "</video>")) : r.$video = e('<video><source src="' + r.path + '.mp4" type="video/mp4"><source src="' + r.path + '.webm" type="video/webm"><source src="' + r.path + '.ogv" type="video/ogg"></video>'),
                r.$video.prop({
                    ...
                    r.$video.css("visibility", "visible"),
                        r.$wrapper.css("background-image", "none")
                }),
            ...
            e(document).ready(function() {
                ...
                t.on("resize.vide", function() {
                    for (var t, n = e[o].lookup.length, i = 0; i < n; i++)
                        t = e[o].lookup[i],
