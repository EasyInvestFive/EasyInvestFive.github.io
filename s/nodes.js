                            ...
                            try {
                                ...
                                var _ = n.width()
                                    ...
                                    try {
                                        ...
                                        n < g && l.css("left", t + g - n),
                                        n > g + y && l.css("left", t - (n - (g + y)))
                                    } catch (a) {
                                        error_handler(a, "libs_nodes 5", arguments.callee)
                                    }
                                };
                                t() ? n.on("move", v) : "hover" === n.data("trigger") ? (n.on("mousemove", v),
                                    ...
                                    try {
                                        b = e(t.target).closest(l).length ? t.pageX - l.offset().left : 0,
                                            e(document).on("mousemove.beforeafter", v),
                                ...
                                e(".widget-countdown").each(function() {
                                    try {
                                        ...
                                        return a = e(this),
                                            ...
                                            h = n.data("vals"),
                                            d = new Date,
                                            "full" === h.type ? (h.full_date.day++,
                                                o = new Date(h.full_date.year,h.full_date.month,h.full_date.day,h.full_time.hour,h.full_time.minute)) : "month" === h.type ? (h.month_day++,
                                                o = new Date(d.getFullYear(),d.getMonth(),h.month_day,h.month_time.hour,h.month_time.minute),
                                            o.getTime() < d.getTime() && (o = new Date(d.getFullYear(),d.getMonth() + 1,h.month_day,h.month_time.hour,h.month_time.minute))) : "week" === h.type ? (l = h.week_day - t(d.getDay()),
                                                o = new Date(d.getFullYear(),d.getMonth(),d.getDate() + l,h.week_time.hour,h.week_time.minute),
                                            o.getTime() < d.getTime() && (l = 7 - t(d.getDay()) + h.week_day,
                                                o = new Date(d.getFullYear(),d.getMonth(),d.getDate() + l,h.week_time.hour,h.week_time.minute))) : "day" === h.type ? (o = new Date(d.getFullYear(),d.getMonth(),d.getDate(),h.day_time.hour,h.day_time.minute),
                                            o.getTime() < d.getTime() && (o = new Date(d.getFullYear(),d.getMonth(),d.getDate() + 1,h.day_time.hour,h.day_time.minute))) : "fake" === h.type && (c = [h.fake_days, h.fake_time.hour, h.fake_time.minute].join(":"),
                                                e.cookie(c) ? o = new Date(1 * e.cookie(c)) : (o = new Date(d.getFullYear(),d.getMonth(),d.getDate() + h.fake_days,d.getHours() + h.fake_time.hour,d.getMinutes() + h.fake_time.minute),
                                                    e.cookie(c, o.getTime(), {
                                                        expires: 365,
                                                        path: "/"
                                                    }))),
                                        void 0 !== h.action && "show_element" === h.action.type && (i = document.getElementById(h.action.element_id),
                                        i && e(i).hide()),
                                            s = function() {
                                                try {
                                                    if (void 0 === h.action || "none" === h.action.type)
                                                        return;
                                                    switch (h.action.type) {
                                                        ...
                                                        case "redirect":
                                                            if (h.action.url)
                                                                return top.location.href = h.action.url;
                                                            break;
                                                        case "show_element":
                                                            if (i = document.getElementById(h.action.element_id),
                                                            i && (e(i).show(),
                                                                plp.lazy))
                                                                return plp.lazy.update();
                                                            break;
                                                        case "hide_element":
                                                            if (i = document.getElementById(h.action.element_id))
                                                                return e(i).hide();
                    ...
                    try {
                        ...
                        var u = new Swiper(l.get(0),{
                            ...
                            on: {
                                slideChange: function() {
                                    try {
                                        c.filter(".is-active").removeClass("is-active"),
                                            c.eq(u.activeIndex).addClass("is-active"),
                                            t(u.oldActiveIndex, u.activeIndex),
                                            r(u.oldActiveIndex, u.activeIndex),
                                            d.text(u.activeIndex + 1),
                                            u.oldActiveIndex = u.activeIndex
